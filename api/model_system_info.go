...
// GetEncoderLocation returns the EncoderLocation field value if set, zero value otherwise.
// Deprecated
func (o *SystemInfo) GetEncoderLocation() FFmpegLocation {
	if o == nil || IsNil(o.EncoderLocation) {
		var ret FFmpegLocation
		return ret
	}
	return *o.EncoderLocation
}
...
// SetEncoderLocation gets a reference to the given FFmpegLocation and assigns it to the EncoderLocation field.
// Deprecated
...
// SetSystemArchitecture gets a reference to the given Architecture and assigns it to the SystemArchitecture field.
...
func (o SystemInfo) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.EncoderLocation) {
		toSerialize["EncoderLocation"] = o.EncoderLocation
	}

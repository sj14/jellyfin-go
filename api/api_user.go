...
type UserAPI interface {
	...
	*/
	AuthenticateUser(ctx context.Context, userId string) ApiAuthenticateUserRequest

	// AuthenticateUserExecute executes the request
	//  @return AuthenticationResult
	AuthenticateUserExecute(r ApiAuthenticateUserRequest) (*AuthenticationResult, *http.Response, error)
	...
	*/
	UpdateUserConfiguration(ctx context.Context, userId string) ApiUpdateUserConfigurationRequest
	...
	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param userId The user id.
	@return ApiUpdateUserEasyPasswordRequest
	*/
	UpdateUserEasyPassword(ctx context.Context, userId string) ApiUpdateUserEasyPasswordRequest

	// UpdateUserEasyPasswordExecute executes the request
	UpdateUserEasyPasswordExecute(r ApiUpdateUserEasyPasswordRequest) (*http.Response, error)
	...
	*/
	UpdateUserPassword(ctx context.Context, userId string) ApiUpdateUserPasswordRequest
...
func (r ApiAuthenticateUserRequest) Pw(pw string) ApiAuthenticateUserRequest {
	r.pw = &pw
	return r
}

// The password sha1-hash.
func (r ApiAuthenticateUserRequest) Password(password string) ApiAuthenticateUserRequest {
	r.password = &password
	return r
}

func (r ApiAuthenticateUserRequest) Execute() (*AuthenticationResult, *http.Response, error) {
...
AuthenticateUser Authenticates a user.
 ...
 @return ApiAuthenticateUserRequest
*/
func (a *UserAPIService) AuthenticateUser(ctx context.Context, userId string) ApiAuthenticateUserRequest {
	return ApiAuthenticateUserRequest{
		ApiService: a,
		ctx: ctx,
		userId: userId,
...
//  @return AuthenticationResult
func (a *UserAPIService) AuthenticateUserExecute(r ApiAuthenticateUserRequest) (*AuthenticationResult, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "UserAPIService.AuthenticateUser")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/Users/{userId}/Authenticate"
	...
	if r.pw == nil {
		return localVarReturnValue, nil, reportError("pw is required and must be specified")
	}
...
UpdateUserConfiguration Updates a user configuration.
 ...
 @return ApiUpdateUserConfigurationRequest
*/
func (a *UserAPIService) UpdateUserConfiguration(ctx context.Context, userId string) ApiUpdateUserConfigurationRequest {
	return ApiUpdateUserConfigurationRequest{
		ApiService: a,
		ctx: ctx,
		userId: userId,
...
func (a *UserAPIService) UpdateUserConfigurationExecute(r ApiUpdateUserConfigurationRequest) (*http.Response, error) {
	...
	localVarPath := localBasePath + "/Users/{userId}/Configuration"
	localVarPath = strings.Replace(localVarPath, "{"+"userId"+"}", url.PathEscape(parameterValueToString(r.userId, "userId")), -1)
...
type ApiUpdateUserEasyPasswordRequest struct {
	ctx context.Context
	ApiService UserAPI
	userId string
...
func (r ApiUpdateUserEasyPasswordRequest) UpdateUserEasyPassword(updateUserEasyPassword UpdateUserEasyPassword) ApiUpdateUserEasyPasswordRequest {
	r.updateUserEasyPassword = &updateUserEasyPassword
	return r
}

func (r ApiUpdateUserEasyPasswordRequest) Execute() (*http.Response, error) {
	return r.ApiService.UpdateUserEasyPasswordExecute(r)
}
...
UpdateUserEasyPassword Updates a user's easy password.
 ...
 @return ApiUpdateUserEasyPasswordRequest
*/
func (a *UserAPIService) UpdateUserEasyPassword(ctx context.Context, userId string) ApiUpdateUserEasyPasswordRequest {
	return ApiUpdateUserEasyPasswordRequest{
		ApiService: a,
		ctx: ctx,
		userId: userId,
...
// Execute executes the request
func (a *UserAPIService) UpdateUserEasyPasswordExecute(r ApiUpdateUserEasyPasswordRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "UserAPIService.UpdateUserEasyPassword")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/Users/{userId}/EasyPassword"
	localVarPath = strings.Replace(localVarPath, "{"+"userId"+"}", url.PathEscape(parameterValueToString(r.userId, "userId")), -1)
...
UpdateUserPassword Updates a user's password.
 ...
 @return ApiUpdateUserPasswordRequest
*/
func (a *UserAPIService) UpdateUserPassword(ctx context.Context, userId string) ApiUpdateUserPasswordRequest {
	return ApiUpdateUserPasswordRequest{
		ApiService: a,
		ctx: ctx,
		userId: userId,

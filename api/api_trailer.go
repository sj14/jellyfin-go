...
func (r ApiGetTrailersRequest) AudioLanguages(audioLanguages []string) ApiGetTrailersRequest {
...
func (r ApiGetTrailersRequest) SubtitleLanguages(subtitleLanguages []string) ApiGetTrailersRequest {
...
Deprecated
*/
func (a *TrailerAPIService) GetTrailers(ctx context.Context) ApiGetTrailersRequest {
	return ApiGetTrailersRequest{
		ApiService: a,
		ctx: ctx,
	}
...
//  @return BaseItemDtoQueryResult
// Deprecated
func (a *TrailerAPIService) GetTrailersExecute(r ApiGetTrailersRequest) (*BaseItemDtoQueryResult, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "TrailerAPIService.GetTrailers")
	if err != nil {

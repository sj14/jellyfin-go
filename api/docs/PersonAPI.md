...
func main() {
	...
	resp, r, err := apiClient.PersonAPI.GetPerson(context.Background(), name).UserId(userId).Execute()
	if err != nil {
...
> BaseItemDtoQueryResult GetPersons(ctx).StartIndex(startIndex).Limit(limit).SearchTerm(searchTerm).NameStartsWith(nameStartsWith).NameLessThan(nameLessThan).NameStartsWithOrGreater(nameStartsWithOrGreater).Fields(fields).Filters(filters).IsFavorite(isFavorite).EnableUserData(enableUserData).ImageTypeLimit(imageTypeLimit).EnableImageTypes(enableImageTypes).ExcludePersonTypes(excludePersonTypes).PersonTypes(personTypes).ParentId(parentId).AppearsInItemId(appearsInItemId).UserId(userId).EnableImages(enableImages).Execute()
...
func main() {
	startIndex := int32(56) // int32 | Optional. All items with a lower index will be dropped from the response. (optional)
	limit := int32(56) // int32 | Optional. The maximum number of records to return. (optional)
	searchTerm := "searchTerm_example" // string | The search term. (optional)
	nameStartsWith := "nameStartsWith_example" // string | Optional. Filter by items whose name starts with the given input string. (optional)
	nameLessThan := "nameLessThan_example" // string | Optional. Filter by items whose name will appear before this value when sorted alphabetically. (optional)
	nameStartsWithOrGreater := "nameStartsWithOrGreater_example" // string | Optional. Filter by items whose name will appear after this value when sorted alphabetically. (optional)
	...
	parentId := "38400000-8cf0-11bd-b23e-10b96e4ef00d" // string | Optional. Specify this to localize the search to a specific library. Omit to use the root. (optional)
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.PersonAPI.GetPersons(context.Background()).StartIndex(startIndex).Limit(limit).SearchTerm(searchTerm).NameStartsWith(nameStartsWith).NameLessThan(nameLessThan).NameStartsWithOrGreater(nameStartsWithOrGreater).Fields(fields).Filters(filters).IsFavorite(isFavorite).EnableUserData(enableUserData).ImageTypeLimit(imageTypeLimit).EnableImageTypes(enableImageTypes).ExcludePersonTypes(excludePersonTypes).PersonTypes(personTypes).ParentId(parentId).AppearsInItemId(appearsInItemId).UserId(userId).EnableImages(enableImages).Execute()
	if err != nil {
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **startIndex** | **int32** | Optional. All items with a lower index will be dropped from the response. | 
 **limit** | **int32** | Optional. The maximum number of records to return. | 
 **searchTerm** | **string** | The search term. | 
 **nameStartsWith** | **string** | Optional. Filter by items whose name starts with the given input string. | 
 **nameLessThan** | **string** | Optional. Filter by items whose name will appear before this value when sorted alphabetically. | 
 **nameStartsWithOrGreater** | **string** | Optional. Filter by items whose name will appear after this value when sorted alphabetically. | 
 ...
 **parentId** | **string** | Optional. Specify this to localize the search to a specific library. Omit to use the root. | 

...
`func (o *SessionInfoNowPlayingItem) SetTrickplayNil(b bool)`

 SetTrickplayNil sets the value for Trickplay to be an explicit nil

### UnsetTrickplay
`func (o *SessionInfoNowPlayingItem) UnsetTrickplay()`
...
`func (o *SessionInfoNowPlayingItem) SetNormalizationGainNil(b bool)`

...
// SuggestionAPIService SuggestionAPI service
type SuggestionAPIService service

type ApiGetSuggestionsRequest struct {
	ctx context.Context
	ApiService SuggestionAPI
	userId *string
	mediaType *[]MediaType
	type_ *[]BaseItemKind
	startIndex *int32
...
GetSuggestions Gets suggestions.
 ...
 @return ApiGetSuggestionsRequest
*/
func (a *SuggestionAPIService) GetSuggestions(ctx context.Context) ApiGetSuggestionsRequest {
	return ApiGetSuggestionsRequest{
		ApiService: a,
		ctx: ctx,
	}
...
//  @return BaseItemDtoQueryResult
func (a *SuggestionAPIService) GetSuggestionsExecute(r ApiGetSuggestionsRequest) (*BaseItemDtoQueryResult, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SuggestionAPIService.GetSuggestions")
	if err != nil {

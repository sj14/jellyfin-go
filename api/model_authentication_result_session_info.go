...
type AuthenticationResultSessionInfo struct {
	...
	NowViewingItem NullableSessionInfoNowPlayingItem `json:"NowViewingItem,omitempty"`
...
func (o *AuthenticationResultSessionInfo) SetLastPausedDateNil() {
...
// SetNowViewingItem gets a reference to the given NullableSessionInfoNowPlayingItem and assigns it to the NowViewingItem field.

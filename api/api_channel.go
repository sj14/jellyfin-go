...
GetAllChannelFeatures Get all channel features.
 ...
 @return ApiGetAllChannelFeaturesRequest
*/
func (a *ChannelAPIService) GetAllChannelFeatures(ctx context.Context) ApiGetAllChannelFeaturesRequest {
	return ApiGetAllChannelFeaturesRequest{
		ApiService: a,
		ctx: ctx,
	}
...
//  @return []ChannelFeatures
func (a *ChannelAPIService) GetAllChannelFeaturesExecute(r ApiGetAllChannelFeaturesRequest) ([]ChannelFeatures, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ChannelAPIService.GetAllChannelFeatures")
	if err != nil {
...
GetChannelFeatures Get channel features.
 ...
 @return ApiGetChannelFeaturesRequest
*/
func (a *ChannelAPIService) GetChannelFeatures(ctx context.Context, channelId string) ApiGetChannelFeaturesRequest {
	return ApiGetChannelFeaturesRequest{
		ApiService: a,
		ctx: ctx,
		channelId: channelId,
...
// Execute executes the request
//  @return ChannelFeatures
func (a *ChannelAPIService) GetChannelFeaturesExecute(r ApiGetChannelFeaturesRequest) (*ChannelFeatures, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ChannelAPIService.GetChannelFeatures")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
GetChannelItems Get channel items.
 ...
 @return ApiGetChannelItemsRequest
*/
func (a *ChannelAPIService) GetChannelItems(ctx context.Context, channelId string) ApiGetChannelItemsRequest {
	return ApiGetChannelItemsRequest{
		ApiService: a,
		ctx: ctx,
		channelId: channelId,
...
// Execute executes the request
//  @return BaseItemDtoQueryResult
func (a *ChannelAPIService) GetChannelItemsExecute(r ApiGetChannelItemsRequest) (*BaseItemDtoQueryResult, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ChannelAPIService.GetChannelItems")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
// Execute executes the request
//  @return BaseItemDtoQueryResult
func (a *ChannelAPIService) GetChannelsExecute(r ApiGetChannelsRequest) (*BaseItemDtoQueryResult, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
GetLatestChannelItems Gets latest channel items.
 ...
 @return ApiGetLatestChannelItemsRequest
*/
func (a *ChannelAPIService) GetLatestChannelItems(ctx context.Context) ApiGetLatestChannelItemsRequest {
	return ApiGetLatestChannelItemsRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return BaseItemDtoQueryResult
func (a *ChannelAPIService) GetLatestChannelItemsExecute(r ApiGetLatestChannelItemsRequest) (*BaseItemDtoQueryResult, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ChannelAPIService.GetLatestChannelItems")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

...
type _UserDtoPolicy UserDtoPolicy
...
func (o *UserDtoPolicy) UnmarshalJSON(data []byte) (err error) {
	...
	varUserDtoPolicy := _UserDtoPolicy{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varUserDtoPolicy)

	if err != nil {
		return err
	}

	*o = UserDtoPolicy(varUserDtoPolicy)

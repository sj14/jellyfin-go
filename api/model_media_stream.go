...
// GetHdr10PlusPresentFlag returns the Hdr10PlusPresentFlag field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *MediaStream) GetHdr10PlusPresentFlag() bool {
	if o == nil || IsNil(o.Hdr10PlusPresentFlag.Get()) {
		var ret bool
		return ret
	}
	return *o.Hdr10PlusPresentFlag.Get()
}

// GetHdr10PlusPresentFlagOk returns a tuple with the Hdr10PlusPresentFlag field value if set, nil otherwise
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
...
// SetHdr10PlusPresentFlag gets a reference to the given NullableBool and assigns it to the Hdr10PlusPresentFlag field.
func (o *MediaStream) SetHdr10PlusPresentFlag(v bool) {
	o.Hdr10PlusPresentFlag.Set(&v)
}
// SetHdr10PlusPresentFlagNil sets the value for Hdr10PlusPresentFlag to be an explicit nil
func (o *MediaStream) SetHdr10PlusPresentFlagNil() {
	o.Hdr10PlusPresentFlag.Set(nil)
}
...
func (o MediaStream) ToMap() (map[string]interface{}, error) {
	...
	if o.Hdr10PlusPresentFlag.IsSet() {
		toSerialize["Hdr10PlusPresentFlag"] = o.Hdr10PlusPresentFlag.Get()
	}

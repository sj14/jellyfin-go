...
type MediaStream struct {
	...
	VideoRange NullableString `json:"VideoRange,omitempty"`
	// Gets the video range type.
	VideoRangeType NullableString `json:"VideoRangeType,omitempty"`
...
// GetVideoRange returns the VideoRange field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *MediaStream) GetVideoRange() string {
	if o == nil || IsNil(o.VideoRange.Get()) {
		var ret string
		return ret
	}
	return *o.VideoRange.Get()
}
...
// SetVideoRange gets a reference to the given NullableString and assigns it to the VideoRange field.
func (o *MediaStream) SetVideoRange(v string) {
	o.VideoRange.Set(&v)
}
// SetVideoRangeNil sets the value for VideoRange to be an explicit nil
func (o *MediaStream) SetVideoRangeNil() {
	o.VideoRange.Set(nil)
}
...
// GetVideoRangeType returns the VideoRangeType field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *MediaStream) GetVideoRangeType() string {
	if o == nil || IsNil(o.VideoRangeType.Get()) {
		var ret string
		return ret
	}
	return *o.VideoRangeType.Get()
}
...
// SetVideoRangeType gets a reference to the given NullableString and assigns it to the VideoRangeType field.
func (o *MediaStream) SetVideoRangeType(v string) {
	o.VideoRangeType.Set(&v)
}
// SetVideoRangeTypeNil sets the value for VideoRangeType to be an explicit nil
func (o *MediaStream) SetVideoRangeTypeNil() {
	o.VideoRangeType.Set(nil)
}
...
func (o MediaStream) ToMap() (map[string]interface{}, error) {
	...
	if o.VideoRange.IsSet() {
		toSerialize["VideoRange"] = o.VideoRange.Get()
	}
	if o.VideoRangeType.IsSet() {
		toSerialize["VideoRangeType"] = o.VideoRangeType.Get()
	}

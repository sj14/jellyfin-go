...
// GetCues returns the Cues field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *LyricLine) GetCues() []LyricLineCue {
	if o == nil {
		var ret []LyricLineCue
		return ret
	}
	return o.Cues
}
...
// SetCues gets a reference to the given []LyricLineCue and assigns it to the Cues field.

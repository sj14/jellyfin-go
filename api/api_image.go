...
type ImageAPI interface {
	...
	*/
	DeleteUserImage(ctx context.Context, userId string, imageType ImageType) ApiDeleteUserImageRequest
	...
	@return ApiDeleteUserImageByIndexRequest
	*/
	DeleteUserImageByIndex(ctx context.Context, userId string, imageType ImageType, index int32) ApiDeleteUserImageByIndexRequest

	// DeleteUserImageByIndexExecute executes the request
	DeleteUserImageByIndexExecute(r ApiDeleteUserImageByIndexRequest) (*http.Response, error)
	...
	*/
	GetUserImage(ctx context.Context, userId string, imageType ImageType) ApiGetUserImageRequest
	...
	@param imageType Image type.
	@param imageIndex Image index.
	@return ApiGetUserImageByIndexRequest
	*/
	GetUserImageByIndex(ctx context.Context, userId string, imageType ImageType, imageIndex int32) ApiGetUserImageByIndexRequest

	// GetUserImageByIndexExecute executes the request
	//  @return *os.File
	GetUserImageByIndexExecute(r ApiGetUserImageByIndexRequest) (*os.File, *http.Response, error)
	...
	*/
	HeadUserImage(ctx context.Context, userId string, imageType ImageType) ApiHeadUserImageRequest
	...
	@param imageType Image type.
	@param imageIndex Image index.
	@return ApiHeadUserImageByIndexRequest
	*/
	HeadUserImageByIndex(ctx context.Context, userId string, imageType ImageType, imageIndex int32) ApiHeadUserImageByIndexRequest

	// HeadUserImageByIndexExecute executes the request
	//  @return *os.File
	HeadUserImageByIndexExecute(r ApiHeadUserImageByIndexRequest) (*os.File, *http.Response, error)
	...
	*/
	PostUserImage(ctx context.Context, userId string, imageType ImageType) ApiPostUserImageRequest
	...
	@param imageType (Unused) Image type.
	@param index (Unused) Image index.
	@return ApiPostUserImageByIndexRequest
	*/
	PostUserImageByIndex(ctx context.Context, userId string, imageType ImageType, index int32) ApiPostUserImageByIndexRequest

	// PostUserImageByIndexExecute executes the request
	PostUserImageByIndexExecute(r ApiPostUserImageByIndexRequest) (*http.Response, error)
...
// (Unused) Image index.
func (r ApiDeleteUserImageRequest) Index(index int32) ApiDeleteUserImageRequest {
	r.index = &index
	return r
}
...
DeleteUserImage Delete the user's image.
 ...
 @return ApiDeleteUserImageRequest
*/
func (a *ImageAPIService) DeleteUserImage(ctx context.Context, userId string, imageType ImageType) ApiDeleteUserImageRequest {
	return ApiDeleteUserImageRequest{
		ApiService: a,
		ctx: ctx,
		userId: userId,
...
func (a *ImageAPIService) DeleteUserImageExecute(r ApiDeleteUserImageRequest) (*http.Response, error) {
	...
	localVarPath := localBasePath + "/Users/{userId}/Images/{imageType}"
...
type ApiDeleteUserImageByIndexRequest struct {
	ctx context.Context
	ApiService ImageAPI
	userId string
	imageType ImageType
...
func (r ApiDeleteUserImageByIndexRequest) Execute() (*http.Response, error) {
	return r.ApiService.DeleteUserImageByIndexExecute(r)
}
...
DeleteUserImageByIndex Delete the user's image.
 ...
 @return ApiDeleteUserImageByIndexRequest
*/
func (a *ImageAPIService) DeleteUserImageByIndex(ctx context.Context, userId string, imageType ImageType, index int32) ApiDeleteUserImageByIndexRequest {
	return ApiDeleteUserImageByIndexRequest{
		ApiService: a,
		ctx: ctx,
		userId: userId,
...
// Execute executes the request
func (a *ImageAPIService) DeleteUserImageByIndexExecute(r ApiDeleteUserImageByIndexRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodDelete
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ImageAPIService.DeleteUserImageByIndex")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/Users/{userId}/Images/{imageType}/{index}"
	localVarPath = strings.Replace(localVarPath, "{"+"userId"+"}", url.PathEscape(parameterValueToString(r.userId, "userId")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"imageType"+"}", url.PathEscape(parameterValueToString(r.imageType, "imageType")), -1)
...
// Deprecated
func (r ApiGetArtistImageRequest) CropWhitespace(cropWhitespace bool) ApiGetArtistImageRequest {
	r.cropWhitespace = &cropWhitespace
	return r
}

// Optional. Add a played indicator.
func (r ApiGetArtistImageRequest) AddPlayedIndicator(addPlayedIndicator bool) ApiGetArtistImageRequest {
...
func (a *ImageAPIService) GetArtistImageExecute(r ApiGetArtistImageRequest) (*os.File, *http.Response, error) {
	...
	if r.addPlayedIndicator != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "addPlayedIndicator", r.addPlayedIndicator, "")
	}
	if r.blur != nil {
...
// Optional. Specify if whitespace should be cropped out of the image. True/False. If unspecified, whitespace will be cropped from logos and clear art.
// Deprecated
func (r ApiGetGenreImageRequest) CropWhitespace(cropWhitespace bool) ApiGetGenreImageRequest {
	r.cropWhitespace = &cropWhitespace
	return r
}

// Optional. Add a played indicator.
func (r ApiGetGenreImageRequest) AddPlayedIndicator(addPlayedIndicator bool) ApiGetGenreImageRequest {
	r.addPlayedIndicator = &addPlayedIndicator
	return r
}
...
// Optional. Specify if whitespace should be cropped out of the image. True/False. If unspecified, whitespace will be cropped from logos and clear art.
// Deprecated
func (r ApiGetGenreImageByIndexRequest) CropWhitespace(cropWhitespace bool) ApiGetGenreImageByIndexRequest {
	r.cropWhitespace = &cropWhitespace
	return r
}

// Optional. Add a played indicator.
func (r ApiGetGenreImageByIndexRequest) AddPlayedIndicator(addPlayedIndicator bool) ApiGetGenreImageByIndexRequest {
	r.addPlayedIndicator = &addPlayedIndicator
	return r
}
...
// Optional. Specify if whitespace should be cropped out of the image. True/False. If unspecified, whitespace will be cropped from logos and clear art.
// Deprecated
func (r ApiGetItemImageRequest) CropWhitespace(cropWhitespace bool) ApiGetItemImageRequest {
	r.cropWhitespace = &cropWhitespace
	return r
}
...
// Optional. Add a played indicator.
func (r ApiGetItemImageRequest) AddPlayedIndicator(addPlayedIndicator bool) ApiGetItemImageRequest {
	r.addPlayedIndicator = &addPlayedIndicator
	return r
}
...
// Optional. Specify if whitespace should be cropped out of the image. True/False. If unspecified, whitespace will be cropped from logos and clear art.
// Deprecated
func (r ApiGetItemImage2Request) CropWhitespace(cropWhitespace bool) ApiGetItemImage2Request {
	r.cropWhitespace = &cropWhitespace
	return r
}

// Optional. Add a played indicator.
func (r ApiGetItemImage2Request) AddPlayedIndicator(addPlayedIndicator bool) ApiGetItemImage2Request {
	r.addPlayedIndicator = &addPlayedIndicator
	return r
}
...
// Optional. Specify if whitespace should be cropped out of the image. True/False. If unspecified, whitespace will be cropped from logos and clear art.
// Deprecated
func (r ApiGetItemImageByIndexRequest) CropWhitespace(cropWhitespace bool) ApiGetItemImageByIndexRequest {
	r.cropWhitespace = &cropWhitespace
	return r
}
...
// Optional. Add a played indicator.
func (r ApiGetItemImageByIndexRequest) AddPlayedIndicator(addPlayedIndicator bool) ApiGetItemImageByIndexRequest {
	r.addPlayedIndicator = &addPlayedIndicator
	return r
}
...
// Optional. Specify if whitespace should be cropped out of the image. True/False. If unspecified, whitespace will be cropped from logos and clear art.
// Deprecated
func (r ApiGetMusicGenreImageRequest) CropWhitespace(cropWhitespace bool) ApiGetMusicGenreImageRequest {
	r.cropWhitespace = &cropWhitespace
	return r
}

// Optional. Add a played indicator.
func (r ApiGetMusicGenreImageRequest) AddPlayedIndicator(addPlayedIndicator bool) ApiGetMusicGenreImageRequest {
	r.addPlayedIndicator = &addPlayedIndicator
	return r
}
...
// Optional. Specify if whitespace should be cropped out of the image. True/False. If unspecified, whitespace will be cropped from logos and clear art.
// Deprecated
func (r ApiGetMusicGenreImageByIndexRequest) CropWhitespace(cropWhitespace bool) ApiGetMusicGenreImageByIndexRequest {
	r.cropWhitespace = &cropWhitespace
	return r
}

// Optional. Add a played indicator.
func (r ApiGetMusicGenreImageByIndexRequest) AddPlayedIndicator(addPlayedIndicator bool) ApiGetMusicGenreImageByIndexRequest {
	r.addPlayedIndicator = &addPlayedIndicator
	return r
}
...
// Optional. Specify if whitespace should be cropped out of the image. True/False. If unspecified, whitespace will be cropped from logos and clear art.
// Deprecated
func (r ApiGetPersonImageRequest) CropWhitespace(cropWhitespace bool) ApiGetPersonImageRequest {
	r.cropWhitespace = &cropWhitespace
	return r
}

// Optional. Add a played indicator.
func (r ApiGetPersonImageRequest) AddPlayedIndicator(addPlayedIndicator bool) ApiGetPersonImageRequest {
	r.addPlayedIndicator = &addPlayedIndicator
	return r
}
...
// Optional. Specify if whitespace should be cropped out of the image. True/False. If unspecified, whitespace will be cropped from logos and clear art.
// Deprecated
func (r ApiGetPersonImageByIndexRequest) CropWhitespace(cropWhitespace bool) ApiGetPersonImageByIndexRequest {
	r.cropWhitespace = &cropWhitespace
	return r
}

// Optional. Add a played indicator.
func (r ApiGetPersonImageByIndexRequest) AddPlayedIndicator(addPlayedIndicator bool) ApiGetPersonImageByIndexRequest {
	r.addPlayedIndicator = &addPlayedIndicator
	return r
}
...
// Optional. Specify if whitespace should be cropped out of the image. True/False. If unspecified, whitespace will be cropped from logos and clear art.
// Deprecated
func (r ApiGetStudioImageRequest) CropWhitespace(cropWhitespace bool) ApiGetStudioImageRequest {
	r.cropWhitespace = &cropWhitespace
	return r
}

// Optional. Add a played indicator.
func (r ApiGetStudioImageRequest) AddPlayedIndicator(addPlayedIndicator bool) ApiGetStudioImageRequest {
	r.addPlayedIndicator = &addPlayedIndicator
	return r
}
...
// Optional. Specify if whitespace should be cropped out of the image. True/False. If unspecified, whitespace will be cropped from logos and clear art.
// Deprecated
func (r ApiGetStudioImageByIndexRequest) CropWhitespace(cropWhitespace bool) ApiGetStudioImageByIndexRequest {
	r.cropWhitespace = &cropWhitespace
	return r
}

// Optional. Add a played indicator.
func (r ApiGetStudioImageByIndexRequest) AddPlayedIndicator(addPlayedIndicator bool) ApiGetStudioImageByIndexRequest {
	r.addPlayedIndicator = &addPlayedIndicator
	return r
}
...
// Optional. Specify if whitespace should be cropped out of the image. True/False. If unspecified, whitespace will be cropped from logos and clear art.
// Deprecated
func (r ApiGetUserImageRequest) CropWhitespace(cropWhitespace bool) ApiGetUserImageRequest {
	r.cropWhitespace = &cropWhitespace
	return r
}

// Optional. Add a played indicator.
func (r ApiGetUserImageRequest) AddPlayedIndicator(addPlayedIndicator bool) ApiGetUserImageRequest {
	r.addPlayedIndicator = &addPlayedIndicator
	return r
}
...
GetUserImage Get user profile image.
 ...
 @return ApiGetUserImageRequest
*/
func (a *ImageAPIService) GetUserImage(ctx context.Context, userId string, imageType ImageType) ApiGetUserImageRequest {
	return ApiGetUserImageRequest{
		ApiService: a,
		ctx: ctx,
		userId: userId,
...
type ApiGetUserImageByIndexRequest struct {
	ctx context.Context
	ApiService ImageAPI
	userId string
	imageType ImageType
...
// Optional. Supply the cache tag from the item object to receive strong caching headers.
func (r ApiGetUserImageByIndexRequest) Tag(tag string) ApiGetUserImageByIndexRequest {
	r.tag = &tag
	return r
}

// Determines the output format of the image - original,gif,jpg,png.
func (r ApiGetUserImageByIndexRequest) Format(format ImageFormat) ApiGetUserImageByIndexRequest {
	r.format = &format
	return r
}

// The maximum image width to return.
func (r ApiGetUserImageByIndexRequest) MaxWidth(maxWidth int32) ApiGetUserImageByIndexRequest {
	r.maxWidth = &maxWidth
	return r
}

// The maximum image height to return.
func (r ApiGetUserImageByIndexRequest) MaxHeight(maxHeight int32) ApiGetUserImageByIndexRequest {
	r.maxHeight = &maxHeight
	return r
}

// Optional. Percent to render for the percent played overlay.
func (r ApiGetUserImageByIndexRequest) PercentPlayed(percentPlayed float64) ApiGetUserImageByIndexRequest {
	r.percentPlayed = &percentPlayed
	return r
}

// Optional. Unplayed count overlay to render.
func (r ApiGetUserImageByIndexRequest) UnplayedCount(unplayedCount int32) ApiGetUserImageByIndexRequest {
	r.unplayedCount = &unplayedCount
	return r
}

// The fixed image width to return.
func (r ApiGetUserImageByIndexRequest) Width(width int32) ApiGetUserImageByIndexRequest {
	r.width = &width
	return r
}

// The fixed image height to return.
func (r ApiGetUserImageByIndexRequest) Height(height int32) ApiGetUserImageByIndexRequest {
	r.height = &height
	return r
}

// Optional. Quality setting, from 0-100. Defaults to 90 and should suffice in most cases.
func (r ApiGetUserImageByIndexRequest) Quality(quality int32) ApiGetUserImageByIndexRequest {
	r.quality = &quality
	return r
}

// Width of box to fill.
func (r ApiGetUserImageByIndexRequest) FillWidth(fillWidth int32) ApiGetUserImageByIndexRequest {
	r.fillWidth = &fillWidth
	return r
}

// Height of box to fill.
func (r ApiGetUserImageByIndexRequest) FillHeight(fillHeight int32) ApiGetUserImageByIndexRequest {
	r.fillHeight = &fillHeight
	return r
}
...
// Optional. Specify if whitespace should be cropped out of the image. True/False. If unspecified, whitespace will be cropped from logos and clear art.
// Deprecated
func (r ApiGetUserImageByIndexRequest) CropWhitespace(cropWhitespace bool) ApiGetUserImageByIndexRequest {
	r.cropWhitespace = &cropWhitespace
	return r
}

// Optional. Add a played indicator.
func (r ApiGetUserImageByIndexRequest) AddPlayedIndicator(addPlayedIndicator bool) ApiGetUserImageByIndexRequest {
	r.addPlayedIndicator = &addPlayedIndicator
	return r
}

// Optional. Blur image.
func (r ApiGetUserImageByIndexRequest) Blur(blur int32) ApiGetUserImageByIndexRequest {
	r.blur = &blur
	return r
}

// Optional. Apply a background color for transparent images.
func (r ApiGetUserImageByIndexRequest) BackgroundColor(backgroundColor string) ApiGetUserImageByIndexRequest {
	r.backgroundColor = &backgroundColor
	return r
}

// Optional. Apply a foreground layer on top of the image.
func (r ApiGetUserImageByIndexRequest) ForegroundLayer(foregroundLayer string) ApiGetUserImageByIndexRequest {
	r.foregroundLayer = &foregroundLayer
	return r
}

func (r ApiGetUserImageByIndexRequest) Execute() (*os.File, *http.Response, error) {
	return r.ApiService.GetUserImageByIndexExecute(r)
}
...
GetUserImageByIndex Get user profile image.
 ...
 @return ApiGetUserImageByIndexRequest
*/
func (a *ImageAPIService) GetUserImageByIndex(ctx context.Context, userId string, imageType ImageType, imageIndex int32) ApiGetUserImageByIndexRequest {
	return ApiGetUserImageByIndexRequest{
		ApiService: a,
		ctx: ctx,
		userId: userId,
...
// Execute executes the request
//  @return *os.File
func (a *ImageAPIService) GetUserImageByIndexExecute(r ApiGetUserImageByIndexRequest) (*os.File, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ImageAPIService.GetUserImageByIndex")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/Users/{userId}/Images/{imageType}/{imageIndex}"
	localVarPath = strings.Replace(localVarPath, "{"+"userId"+"}", url.PathEscape(parameterValueToString(r.userId, "userId")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"imageType"+"}", url.PathEscape(parameterValueToString(r.imageType, "imageType")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"imageIndex"+"}", url.PathEscape(parameterValueToString(r.imageIndex, "imageIndex")), -1)
...
// Optional. Specify if whitespace should be cropped out of the image. True/False. If unspecified, whitespace will be cropped from logos and clear art.
// Deprecated
func (r ApiHeadArtistImageRequest) CropWhitespace(cropWhitespace bool) ApiHeadArtistImageRequest {
	r.cropWhitespace = &cropWhitespace
	return r
}

// Optional. Add a played indicator.
func (r ApiHeadArtistImageRequest) AddPlayedIndicator(addPlayedIndicator bool) ApiHeadArtistImageRequest {
	r.addPlayedIndicator = &addPlayedIndicator
	return r
}
...
// Optional. Specify if whitespace should be cropped out of the image. True/False. If unspecified, whitespace will be cropped from logos and clear art.
// Deprecated
func (r ApiHeadGenreImageRequest) CropWhitespace(cropWhitespace bool) ApiHeadGenreImageRequest {
	r.cropWhitespace = &cropWhitespace
	return r
}

// Optional. Add a played indicator.
func (r ApiHeadGenreImageRequest) AddPlayedIndicator(addPlayedIndicator bool) ApiHeadGenreImageRequest {
	r.addPlayedIndicator = &addPlayedIndicator
	return r
}
...
// Optional. Specify if whitespace should be cropped out of the image. True/False. If unspecified, whitespace will be cropped from logos and clear art.
// Deprecated
func (r ApiHeadGenreImageByIndexRequest) CropWhitespace(cropWhitespace bool) ApiHeadGenreImageByIndexRequest {
	r.cropWhitespace = &cropWhitespace
	return r
}

// Optional. Add a played indicator.
func (r ApiHeadGenreImageByIndexRequest) AddPlayedIndicator(addPlayedIndicator bool) ApiHeadGenreImageByIndexRequest {
	r.addPlayedIndicator = &addPlayedIndicator
	return r
}
...
// Optional. Specify if whitespace should be cropped out of the image. True/False. If unspecified, whitespace will be cropped from logos and clear art.
// Deprecated
func (r ApiHeadItemImageRequest) CropWhitespace(cropWhitespace bool) ApiHeadItemImageRequest {
	r.cropWhitespace = &cropWhitespace
	return r
}
...
// Optional. Add a played indicator.
func (r ApiHeadItemImageRequest) AddPlayedIndicator(addPlayedIndicator bool) ApiHeadItemImageRequest {
	r.addPlayedIndicator = &addPlayedIndicator
	return r
}
...
// Optional. Specify if whitespace should be cropped out of the image. True/False. If unspecified, whitespace will be cropped from logos and clear art.
// Deprecated
func (r ApiHeadItemImage2Request) CropWhitespace(cropWhitespace bool) ApiHeadItemImage2Request {
	r.cropWhitespace = &cropWhitespace
	return r
}

// Optional. Add a played indicator.
func (r ApiHeadItemImage2Request) AddPlayedIndicator(addPlayedIndicator bool) ApiHeadItemImage2Request {
	r.addPlayedIndicator = &addPlayedIndicator
	return r
}
...
// Optional. Specify if whitespace should be cropped out of the image. True/False. If unspecified, whitespace will be cropped from logos and clear art.
// Deprecated
func (r ApiHeadItemImageByIndexRequest) CropWhitespace(cropWhitespace bool) ApiHeadItemImageByIndexRequest {
	r.cropWhitespace = &cropWhitespace
	return r
}
...
// Optional. Add a played indicator.
func (r ApiHeadItemImageByIndexRequest) AddPlayedIndicator(addPlayedIndicator bool) ApiHeadItemImageByIndexRequest {
	r.addPlayedIndicator = &addPlayedIndicator
	return r
}
...
// Optional. Specify if whitespace should be cropped out of the image. True/False. If unspecified, whitespace will be cropped from logos and clear art.
// Deprecated
func (r ApiHeadMusicGenreImageRequest) CropWhitespace(cropWhitespace bool) ApiHeadMusicGenreImageRequest {
	r.cropWhitespace = &cropWhitespace
	return r
}

// Optional. Add a played indicator.
func (r ApiHeadMusicGenreImageRequest) AddPlayedIndicator(addPlayedIndicator bool) ApiHeadMusicGenreImageRequest {
	r.addPlayedIndicator = &addPlayedIndicator
	return r
}
...
// Optional. Specify if whitespace should be cropped out of the image. True/False. If unspecified, whitespace will be cropped from logos and clear art.
// Deprecated
func (r ApiHeadMusicGenreImageByIndexRequest) CropWhitespace(cropWhitespace bool) ApiHeadMusicGenreImageByIndexRequest {
	r.cropWhitespace = &cropWhitespace
	return r
}

// Optional. Add a played indicator.
func (r ApiHeadMusicGenreImageByIndexRequest) AddPlayedIndicator(addPlayedIndicator bool) ApiHeadMusicGenreImageByIndexRequest {
	r.addPlayedIndicator = &addPlayedIndicator
	return r
}
...
// Optional. Specify if whitespace should be cropped out of the image. True/False. If unspecified, whitespace will be cropped from logos and clear art.
// Deprecated
func (r ApiHeadPersonImageRequest) CropWhitespace(cropWhitespace bool) ApiHeadPersonImageRequest {
	r.cropWhitespace = &cropWhitespace
	return r
}

// Optional. Add a played indicator.
func (r ApiHeadPersonImageRequest) AddPlayedIndicator(addPlayedIndicator bool) ApiHeadPersonImageRequest {
	r.addPlayedIndicator = &addPlayedIndicator
	return r
}
...
// Optional. Specify if whitespace should be cropped out of the image. True/False. If unspecified, whitespace will be cropped from logos and clear art.
// Deprecated
func (r ApiHeadPersonImageByIndexRequest) CropWhitespace(cropWhitespace bool) ApiHeadPersonImageByIndexRequest {
	r.cropWhitespace = &cropWhitespace
	return r
}

// Optional. Add a played indicator.
func (r ApiHeadPersonImageByIndexRequest) AddPlayedIndicator(addPlayedIndicator bool) ApiHeadPersonImageByIndexRequest {
	r.addPlayedIndicator = &addPlayedIndicator
	return r
}
...
// Optional. Specify if whitespace should be cropped out of the image. True/False. If unspecified, whitespace will be cropped from logos and clear art.
// Deprecated
func (r ApiHeadStudioImageRequest) CropWhitespace(cropWhitespace bool) ApiHeadStudioImageRequest {
	r.cropWhitespace = &cropWhitespace
	return r
}

// Optional. Add a played indicator.
func (r ApiHeadStudioImageRequest) AddPlayedIndicator(addPlayedIndicator bool) ApiHeadStudioImageRequest {
	r.addPlayedIndicator = &addPlayedIndicator
	return r
}
...
// Optional. Specify if whitespace should be cropped out of the image. True/False. If unspecified, whitespace will be cropped from logos and clear art.
// Deprecated
func (r ApiHeadStudioImageByIndexRequest) CropWhitespace(cropWhitespace bool) ApiHeadStudioImageByIndexRequest {
	r.cropWhitespace = &cropWhitespace
	return r
}

// Optional. Add a played indicator.
func (r ApiHeadStudioImageByIndexRequest) AddPlayedIndicator(addPlayedIndicator bool) ApiHeadStudioImageByIndexRequest {
	r.addPlayedIndicator = &addPlayedIndicator
	return r
}
...
// Optional. Specify if whitespace should be cropped out of the image. True/False. If unspecified, whitespace will be cropped from logos and clear art.
// Deprecated
func (r ApiHeadUserImageRequest) CropWhitespace(cropWhitespace bool) ApiHeadUserImageRequest {
	r.cropWhitespace = &cropWhitespace
	return r
}

// Optional. Add a played indicator.
func (r ApiHeadUserImageRequest) AddPlayedIndicator(addPlayedIndicator bool) ApiHeadUserImageRequest {
	r.addPlayedIndicator = &addPlayedIndicator
	return r
}
...
HeadUserImage Get user profile image.
 ...
 @return ApiHeadUserImageRequest
*/
func (a *ImageAPIService) HeadUserImage(ctx context.Context, userId string, imageType ImageType) ApiHeadUserImageRequest {
	return ApiHeadUserImageRequest{
		ApiService: a,
		ctx: ctx,
		userId: userId,
...
type ApiHeadUserImageByIndexRequest struct {
	ctx context.Context
	ApiService ImageAPI
	userId string
	imageType ImageType
...
// Optional. Supply the cache tag from the item object to receive strong caching headers.
func (r ApiHeadUserImageByIndexRequest) Tag(tag string) ApiHeadUserImageByIndexRequest {
	r.tag = &tag
	return r
}

// Determines the output format of the image - original,gif,jpg,png.
func (r ApiHeadUserImageByIndexRequest) Format(format ImageFormat) ApiHeadUserImageByIndexRequest {
	r.format = &format
	return r
}

// The maximum image width to return.
func (r ApiHeadUserImageByIndexRequest) MaxWidth(maxWidth int32) ApiHeadUserImageByIndexRequest {
	r.maxWidth = &maxWidth
	return r
}

// The maximum image height to return.
func (r ApiHeadUserImageByIndexRequest) MaxHeight(maxHeight int32) ApiHeadUserImageByIndexRequest {
	r.maxHeight = &maxHeight
	return r
}

// Optional. Percent to render for the percent played overlay.
func (r ApiHeadUserImageByIndexRequest) PercentPlayed(percentPlayed float64) ApiHeadUserImageByIndexRequest {
	r.percentPlayed = &percentPlayed
	return r
}

// Optional. Unplayed count overlay to render.
func (r ApiHeadUserImageByIndexRequest) UnplayedCount(unplayedCount int32) ApiHeadUserImageByIndexRequest {
	r.unplayedCount = &unplayedCount
	return r
}

// The fixed image width to return.
func (r ApiHeadUserImageByIndexRequest) Width(width int32) ApiHeadUserImageByIndexRequest {
	r.width = &width
	return r
}

// The fixed image height to return.
func (r ApiHeadUserImageByIndexRequest) Height(height int32) ApiHeadUserImageByIndexRequest {
	r.height = &height
	return r
}

// Optional. Quality setting, from 0-100. Defaults to 90 and should suffice in most cases.
func (r ApiHeadUserImageByIndexRequest) Quality(quality int32) ApiHeadUserImageByIndexRequest {
	r.quality = &quality
	return r
}

// Width of box to fill.
func (r ApiHeadUserImageByIndexRequest) FillWidth(fillWidth int32) ApiHeadUserImageByIndexRequest {
	r.fillWidth = &fillWidth
	return r
}

// Height of box to fill.
func (r ApiHeadUserImageByIndexRequest) FillHeight(fillHeight int32) ApiHeadUserImageByIndexRequest {
	r.fillHeight = &fillHeight
	return r
}
...
// Optional. Specify if whitespace should be cropped out of the image. True/False. If unspecified, whitespace will be cropped from logos and clear art.
// Deprecated
func (r ApiHeadUserImageByIndexRequest) CropWhitespace(cropWhitespace bool) ApiHeadUserImageByIndexRequest {
	r.cropWhitespace = &cropWhitespace
	return r
}

// Optional. Add a played indicator.
func (r ApiHeadUserImageByIndexRequest) AddPlayedIndicator(addPlayedIndicator bool) ApiHeadUserImageByIndexRequest {
	r.addPlayedIndicator = &addPlayedIndicator
	return r
}

// Optional. Blur image.
func (r ApiHeadUserImageByIndexRequest) Blur(blur int32) ApiHeadUserImageByIndexRequest {
	r.blur = &blur
	return r
}

// Optional. Apply a background color for transparent images.
func (r ApiHeadUserImageByIndexRequest) BackgroundColor(backgroundColor string) ApiHeadUserImageByIndexRequest {
	r.backgroundColor = &backgroundColor
	return r
}

// Optional. Apply a foreground layer on top of the image.
func (r ApiHeadUserImageByIndexRequest) ForegroundLayer(foregroundLayer string) ApiHeadUserImageByIndexRequest {
	r.foregroundLayer = &foregroundLayer
	return r
}

func (r ApiHeadUserImageByIndexRequest) Execute() (*os.File, *http.Response, error) {
	return r.ApiService.HeadUserImageByIndexExecute(r)
}
...
HeadUserImageByIndex Get user profile image.
 ...
 @return ApiHeadUserImageByIndexRequest
*/
func (a *ImageAPIService) HeadUserImageByIndex(ctx context.Context, userId string, imageType ImageType, imageIndex int32) ApiHeadUserImageByIndexRequest {
	return ApiHeadUserImageByIndexRequest{
		ApiService: a,
		ctx: ctx,
		userId: userId,
...
// Execute executes the request
//  @return *os.File
func (a *ImageAPIService) HeadUserImageByIndexExecute(r ApiHeadUserImageByIndexRequest) (*os.File, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodHead
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ImageAPIService.HeadUserImageByIndex")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
// (Unused) Image index.
func (r ApiPostUserImageRequest) Index(index int32) ApiPostUserImageRequest {
	r.index = &index
	return r
}
...
PostUserImage Sets the user image.
 ...
 @return ApiPostUserImageRequest
*/
func (a *ImageAPIService) PostUserImage(ctx context.Context, userId string, imageType ImageType) ApiPostUserImageRequest {
	return ApiPostUserImageRequest{
		ApiService: a,
		ctx: ctx,
		userId: userId,
...
type ApiPostUserImageByIndexRequest struct {
	ctx context.Context
	ApiService ImageAPI
	userId string
	imageType ImageType
...
func (r ApiPostUserImageByIndexRequest) Body(body *os.File) ApiPostUserImageByIndexRequest {
	r.body = body
	return r
}

func (r ApiPostUserImageByIndexRequest) Execute() (*http.Response, error) {
	return r.ApiService.PostUserImageByIndexExecute(r)
}
...
PostUserImageByIndex Sets the user image.
 ...
 @return ApiPostUserImageByIndexRequest
*/
func (a *ImageAPIService) PostUserImageByIndex(ctx context.Context, userId string, imageType ImageType, index int32) ApiPostUserImageByIndexRequest {
	return ApiPostUserImageByIndexRequest{
		ApiService: a,
		ctx: ctx,
		userId: userId,
...
// Execute executes the request
func (a *ImageAPIService) PostUserImageByIndexExecute(r ApiPostUserImageByIndexRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ImageAPIService.PostUserImageByIndex")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

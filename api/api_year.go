...
// YearAPIService YearAPI service
type YearAPIService service
...
GetYear Gets a year.
 ...
 @return ApiGetYearRequest
*/
func (a *YearAPIService) GetYear(ctx context.Context, year int32) ApiGetYearRequest {
	return ApiGetYearRequest{
		ApiService: a,
		ctx: ctx,
		year: year,
...
//  @return BaseItemDto
func (a *YearAPIService) GetYearExecute(r ApiGetYearRequest) (*BaseItemDto, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "YearAPIService.GetYear")
	if err != nil {
...
GetYears Get years.
 ...
 @return ApiGetYearsRequest
*/
func (a *YearAPIService) GetYears(ctx context.Context) ApiGetYearsRequest {
	return ApiGetYearsRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return BaseItemDtoQueryResult
func (a *YearAPIService) GetYearsExecute(r ApiGetYearsRequest) (*BaseItemDtoQueryResult, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "YearAPIService.GetYears")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

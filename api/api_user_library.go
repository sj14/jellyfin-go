...
type UserLibraryAPI interface {
	...
	*/
	DeleteUserItemRating(ctx context.Context, userId string, itemId string) ApiDeleteUserItemRatingRequest
	...
	*/
	GetIntros(ctx context.Context, userId string, itemId string) ApiGetIntrosRequest
	...
	*/
	GetItem(ctx context.Context, userId string, itemId string) ApiGetItemRequest
	...
	*/
	GetLatestMedia(ctx context.Context, userId string) ApiGetLatestMediaRequest
	...
	*/
	GetLocalTrailers(ctx context.Context, userId string, itemId string) ApiGetLocalTrailersRequest
	...
	*/
	GetRootFolder(ctx context.Context, userId string) ApiGetRootFolderRequest
	...
	*/
	GetSpecialFeatures(ctx context.Context, userId string, itemId string) ApiGetSpecialFeaturesRequest
	...
	*/
	MarkFavoriteItem(ctx context.Context, userId string, itemId string) ApiMarkFavoriteItemRequest
	...
	*/
	UnmarkFavoriteItem(ctx context.Context, userId string, itemId string) ApiUnmarkFavoriteItemRequest
	...
	*/
	UpdateUserItemRating(ctx context.Context, userId string, itemId string) ApiUpdateUserItemRatingRequest
...
DeleteUserItemRating Deletes a user's saved personal rating for an item.
 ...
 @return ApiDeleteUserItemRatingRequest
*/
func (a *UserLibraryAPIService) DeleteUserItemRating(ctx context.Context, userId string, itemId string) ApiDeleteUserItemRatingRequest {
	return ApiDeleteUserItemRatingRequest{
		ApiService: a,
		ctx: ctx,
		userId: userId,
...
func (a *UserLibraryAPIService) DeleteUserItemRatingExecute(r ApiDeleteUserItemRatingRequest) (*UserItemDataDto, *http.Response, error) {
	...
	localVarPath := localBasePath + "/Users/{userId}/Items/{itemId}/Rating"
...
GetIntros Gets intros to play before the main media item plays.
 ...
 @return ApiGetIntrosRequest
*/
func (a *UserLibraryAPIService) GetIntros(ctx context.Context, userId string, itemId string) ApiGetIntrosRequest {
	return ApiGetIntrosRequest{
		ApiService: a,
		ctx: ctx,
		userId: userId,
...
func (a *UserLibraryAPIService) GetIntrosExecute(r ApiGetIntrosRequest) (*BaseItemDtoQueryResult, *http.Response, error) {
	...
	localVarPath := localBasePath + "/Users/{userId}/Items/{itemId}/Intros"
	localVarPath = strings.Replace(localVarPath, "{"+"userId"+"}", url.PathEscape(parameterValueToString(r.userId, "userId")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"itemId"+"}", url.PathEscape(parameterValueToString(r.itemId, "itemId")), -1)
...
GetItem Gets an item from a user's library.
 ...
 @return ApiGetItemRequest
*/
func (a *UserLibraryAPIService) GetItem(ctx context.Context, userId string, itemId string) ApiGetItemRequest {
	return ApiGetItemRequest{
		ApiService: a,
		ctx: ctx,
		userId: userId,
...
func (a *UserLibraryAPIService) GetItemExecute(r ApiGetItemRequest) (*BaseItemDto, *http.Response, error) {
	...
	localVarPath := localBasePath + "/Users/{userId}/Items/{itemId}"
	localVarPath = strings.Replace(localVarPath, "{"+"userId"+"}", url.PathEscape(parameterValueToString(r.userId, "userId")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"itemId"+"}", url.PathEscape(parameterValueToString(r.itemId, "itemId")), -1)
...
GetLatestMedia Gets latest media.
 ...
 @return ApiGetLatestMediaRequest
*/
func (a *UserLibraryAPIService) GetLatestMedia(ctx context.Context, userId string) ApiGetLatestMediaRequest {
	return ApiGetLatestMediaRequest{
		ApiService: a,
		ctx: ctx,
		userId: userId,
...
GetLocalTrailers Gets local trailers for an item.
 ...
 @return ApiGetLocalTrailersRequest
*/
func (a *UserLibraryAPIService) GetLocalTrailers(ctx context.Context, userId string, itemId string) ApiGetLocalTrailersRequest {
	return ApiGetLocalTrailersRequest{
		ApiService: a,
		ctx: ctx,
		userId: userId,
...
func (a *UserLibraryAPIService) GetLocalTrailersExecute(r ApiGetLocalTrailersRequest) ([]BaseItemDto, *http.Response, error) {
	...
	localVarPath := localBasePath + "/Users/{userId}/Items/{itemId}/LocalTrailers"
	localVarPath = strings.Replace(localVarPath, "{"+"userId"+"}", url.PathEscape(parameterValueToString(r.userId, "userId")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"itemId"+"}", url.PathEscape(parameterValueToString(r.itemId, "itemId")), -1)
...
GetRootFolder Gets the root folder from a user's library.
 ...
 @return ApiGetRootFolderRequest
*/
func (a *UserLibraryAPIService) GetRootFolder(ctx context.Context, userId string) ApiGetRootFolderRequest {
	return ApiGetRootFolderRequest{
		ApiService: a,
		ctx: ctx,
		userId: userId,
...
GetSpecialFeatures Gets special features for an item.
 ...
 @return ApiGetSpecialFeaturesRequest
*/
func (a *UserLibraryAPIService) GetSpecialFeatures(ctx context.Context, userId string, itemId string) ApiGetSpecialFeaturesRequest {
	return ApiGetSpecialFeaturesRequest{
		ApiService: a,
		ctx: ctx,
		userId: userId,
...
func (a *UserLibraryAPIService) GetSpecialFeaturesExecute(r ApiGetSpecialFeaturesRequest) ([]BaseItemDto, *http.Response, error) {
	...
	localVarPath := localBasePath + "/Users/{userId}/Items/{itemId}/SpecialFeatures"
	localVarPath = strings.Replace(localVarPath, "{"+"userId"+"}", url.PathEscape(parameterValueToString(r.userId, "userId")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"itemId"+"}", url.PathEscape(parameterValueToString(r.itemId, "itemId")), -1)
...
MarkFavoriteItem Marks an item as a favorite.
 ...
 @return ApiMarkFavoriteItemRequest
*/
func (a *UserLibraryAPIService) MarkFavoriteItem(ctx context.Context, userId string, itemId string) ApiMarkFavoriteItemRequest {
	return ApiMarkFavoriteItemRequest{
		ApiService: a,
		ctx: ctx,
		userId: userId,
...
func (a *UserLibraryAPIService) MarkFavoriteItemExecute(r ApiMarkFavoriteItemRequest) (*UserItemDataDto, *http.Response, error) {
	...
	localVarPath := localBasePath + "/Users/{userId}/FavoriteItems/{itemId}"
	localVarPath = strings.Replace(localVarPath, "{"+"userId"+"}", url.PathEscape(parameterValueToString(r.userId, "userId")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"itemId"+"}", url.PathEscape(parameterValueToString(r.itemId, "itemId")), -1)
...
UnmarkFavoriteItem Unmarks item as a favorite.
 ...
 @return ApiUnmarkFavoriteItemRequest
*/
func (a *UserLibraryAPIService) UnmarkFavoriteItem(ctx context.Context, userId string, itemId string) ApiUnmarkFavoriteItemRequest {
	return ApiUnmarkFavoriteItemRequest{
		ApiService: a,
		ctx: ctx,
		userId: userId,
...
UpdateUserItemRating Updates a user's rating for an item.
 ...
 @return ApiUpdateUserItemRatingRequest
*/
func (a *UserLibraryAPIService) UpdateUserItemRating(ctx context.Context, userId string, itemId string) ApiUpdateUserItemRatingRequest {
	return ApiUpdateUserItemRatingRequest{
		ApiService: a,
		ctx: ctx,
		userId: userId,

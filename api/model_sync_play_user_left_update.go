...
// checks if the SyncPlayUserLeftUpdate type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SyncPlayUserLeftUpdate{}

// SyncPlayUserLeftUpdate struct for SyncPlayUserLeftUpdate
...
func (o SyncPlayUserLeftUpdate) MarshalJSON() ([]byte, error) {
...
func (o SyncPlayUserLeftUpdate) ToMap() (map[string]interface{}, error) {
...
type NullableSyncPlayUserLeftUpdate struct {
	value *SyncPlayUserLeftUpdate
	isSet bool
}

func (v NullableSyncPlayUserLeftUpdate) Get() *SyncPlayUserLeftUpdate {
	return v.value
}

func (v *NullableSyncPlayUserLeftUpdate) Set(val *SyncPlayUserLeftUpdate) {
	v.value = val
	v.isSet = true
}

func (v NullableSyncPlayUserLeftUpdate) IsSet() bool {
	return v.isSet
}

func (v *NullableSyncPlayUserLeftUpdate) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSyncPlayUserLeftUpdate(val *SyncPlayUserLeftUpdate) *NullableSyncPlayUserLeftUpdate {
	return &NullableSyncPlayUserLeftUpdate{value: val, isSet: true}
}

func (v NullableSyncPlayUserLeftUpdate) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSyncPlayUserLeftUpdate) UnmarshalJSON(src []byte) error {
	v.isSet = true

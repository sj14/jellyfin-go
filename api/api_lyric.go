...
// LyricAPIService LyricAPI service
type LyricAPIService service
...
DeleteLyrics Deletes an external lyric file.
 ...
 @return ApiDeleteLyricsRequest
*/
func (a *LyricAPIService) DeleteLyrics(ctx context.Context, itemId string) ApiDeleteLyricsRequest {
	return ApiDeleteLyricsRequest{
		ApiService: a,
		ctx: ctx,
		itemId: itemId,
...
func (a *LyricAPIService) DeleteLyricsExecute(r ApiDeleteLyricsRequest) (*http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "LyricAPIService.DeleteLyrics")
	if err != nil {
...
DownloadRemoteLyrics Downloads a remote lyric.
 ...
 @return ApiDownloadRemoteLyricsRequest
*/
func (a *LyricAPIService) DownloadRemoteLyrics(ctx context.Context, itemId string, lyricId string) ApiDownloadRemoteLyricsRequest {
	return ApiDownloadRemoteLyricsRequest{
		ApiService: a,
		ctx: ctx,
		itemId: itemId,
...
// Execute executes the request
//  @return LyricDto
func (a *LyricAPIService) DownloadRemoteLyricsExecute(r ApiDownloadRemoteLyricsRequest) (*LyricDto, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "LyricAPIService.DownloadRemoteLyrics")
	if err != nil {
...
GetLyrics Gets an item's lyrics.
 ...
 @return ApiGetLyricsRequest
*/
func (a *LyricAPIService) GetLyrics(ctx context.Context, itemId string) ApiGetLyricsRequest {
	return ApiGetLyricsRequest{
		ApiService: a,
		ctx: ctx,
		itemId: itemId,
...
// Execute executes the request
//  @return LyricDto
func (a *LyricAPIService) GetLyricsExecute(r ApiGetLyricsRequest) (*LyricDto, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "LyricAPIService.GetLyrics")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
GetRemoteLyrics Gets the remote lyrics.
 ...
 @return ApiGetRemoteLyricsRequest
*/
func (a *LyricAPIService) GetRemoteLyrics(ctx context.Context, lyricId string) ApiGetRemoteLyricsRequest {
	return ApiGetRemoteLyricsRequest{
		ApiService: a,
		ctx: ctx,
		lyricId: lyricId,
...
// Execute executes the request
//  @return LyricDto
func (a *LyricAPIService) GetRemoteLyricsExecute(r ApiGetRemoteLyricsRequest) (*LyricDto, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "LyricAPIService.GetRemoteLyrics")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
SearchRemoteLyrics Search remote lyrics.
 ...
 @return ApiSearchRemoteLyricsRequest
*/
func (a *LyricAPIService) SearchRemoteLyrics(ctx context.Context, itemId string) ApiSearchRemoteLyricsRequest {
	return ApiSearchRemoteLyricsRequest{
		ApiService: a,
		ctx: ctx,
		itemId: itemId,
...
// Execute executes the request
//  @return []RemoteLyricInfoDto
func (a *LyricAPIService) SearchRemoteLyricsExecute(r ApiSearchRemoteLyricsRequest) ([]RemoteLyricInfoDto, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "LyricAPIService.SearchRemoteLyrics")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
UploadLyrics Upload an external lyric file.
 ...
 @return ApiUploadLyricsRequest
*/
func (a *LyricAPIService) UploadLyrics(ctx context.Context, itemId string) ApiUploadLyricsRequest {
	return ApiUploadLyricsRequest{
		ApiService: a,
		ctx: ctx,
		itemId: itemId,
...
// Execute executes the request
//  @return LyricDto
func (a *LyricAPIService) UploadLyricsExecute(r ApiUploadLyricsRequest) (*LyricDto, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "LyricAPIService.UploadLyrics")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

...
type OpenLiveStreamDto struct {
	...
	DeviceProfile NullableClientCapabilitiesDtoDeviceProfile `json:"DeviceProfile,omitempty"`
...
func (o *OpenLiveStreamDto) GetDeviceProfile() ClientCapabilitiesDtoDeviceProfile {
	if o == nil || IsNil(o.DeviceProfile.Get()) {
		var ret ClientCapabilitiesDtoDeviceProfile
		return ret
	}
...
// SetDeviceProfile gets a reference to the given NullableClientCapabilitiesDtoDeviceProfile and assigns it to the DeviceProfile field.

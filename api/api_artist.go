...
Deprecated
*/
func (a *ArtistAPIService) GetAlbumArtists(ctx context.Context) ApiGetAlbumArtistsRequest {
	return ApiGetAlbumArtistsRequest{
		ApiService: a,
		ctx: ctx,
	}
...
//  @return BaseItemDtoQueryResult
// Deprecated
func (a *ArtistAPIService) GetAlbumArtistsExecute(r ApiGetAlbumArtistsRequest) (*BaseItemDtoQueryResult, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ArtistAPIService.GetAlbumArtists")
	if err != nil {
...
Deprecated
*/
func (a *ArtistAPIService) GetArtistByName(ctx context.Context, name string) ApiGetArtistByNameRequest {
	return ApiGetArtistByNameRequest{
		ApiService: a,
		ctx: ctx,
		name: name,
...
//  @return BaseItemDto
// Deprecated
func (a *ArtistAPIService) GetArtistByNameExecute(r ApiGetArtistByNameRequest) (*BaseItemDto, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ArtistAPIService.GetArtistByName")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
Deprecated
*/
func (a *ArtistAPIService) GetArtists(ctx context.Context) ApiGetArtistsRequest {
	return ApiGetArtistsRequest{
		ApiService: a,
		ctx: ctx,
	}
...
//  @return BaseItemDtoQueryResult
// Deprecated
func (a *ArtistAPIService) GetArtistsExecute(r ApiGetArtistsRequest) (*BaseItemDtoQueryResult, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ArtistAPIService.GetArtists")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

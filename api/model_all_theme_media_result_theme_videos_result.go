...
// checks if the AllThemeMediaResultThemeVideosResult type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AllThemeMediaResultThemeVideosResult{}

// AllThemeMediaResultThemeVideosResult Class ThemeMediaResult.
type AllThemeMediaResultThemeVideosResult struct {
...
func NewAllThemeMediaResultThemeVideosResult() *AllThemeMediaResultThemeVideosResult {
	this := AllThemeMediaResultThemeVideosResult{}
	return &this
}
...
func (o AllThemeMediaResultThemeVideosResult) MarshalJSON() ([]byte, error) {
...
func (o AllThemeMediaResultThemeVideosResult) ToMap() (map[string]interface{}, error) {
...
type NullableAllThemeMediaResultThemeVideosResult struct {
	value *AllThemeMediaResultThemeVideosResult
	isSet bool
}

func (v NullableAllThemeMediaResultThemeVideosResult) Get() *AllThemeMediaResultThemeVideosResult {
	return v.value
}

func (v *NullableAllThemeMediaResultThemeVideosResult) Set(val *AllThemeMediaResultThemeVideosResult) {
	v.value = val
	v.isSet = true
}

func (v NullableAllThemeMediaResultThemeVideosResult) IsSet() bool {
	return v.isSet
}

func (v *NullableAllThemeMediaResultThemeVideosResult) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAllThemeMediaResultThemeVideosResult(val *AllThemeMediaResultThemeVideosResult) *NullableAllThemeMediaResultThemeVideosResult {
	return &NullableAllThemeMediaResultThemeVideosResult{value: val, isSet: true}
}

func (v NullableAllThemeMediaResultThemeVideosResult) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAllThemeMediaResultThemeVideosResult) UnmarshalJSON(src []byte) error {
	v.isSet = true

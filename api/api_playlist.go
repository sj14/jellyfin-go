...
func (r ApiAddItemToPlaylistRequest) Position(position int32) ApiAddItemToPlaylistRequest {
	r.position = &position
	return r
}
...
AddItemToPlaylist Adds items to a playlist.
 ...
 @return ApiAddItemToPlaylistRequest
*/
func (a *PlaylistAPIService) AddItemToPlaylist(ctx context.Context, playlistId string) ApiAddItemToPlaylistRequest {
	return ApiAddItemToPlaylistRequest{
		ApiService: a,
		ctx: ctx,
...
func (a *PlaylistAPIService) AddItemToPlaylistExecute(r ApiAddItemToPlaylistRequest) (*http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "PlaylistAPIService.AddItemToPlaylist")
	if err != nil {
...
Query parameters are obsolete.
 ...
 @return ApiCreatePlaylistRequest
*/
func (a *PlaylistAPIService) CreatePlaylist(ctx context.Context) ApiCreatePlaylistRequest {
	return ApiCreatePlaylistRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return PlaylistCreationResult
func (a *PlaylistAPIService) CreatePlaylistExecute(r ApiCreatePlaylistRequest) (*PlaylistCreationResult, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "PlaylistAPIService.CreatePlaylist")
	if err != nil {
...
GetPlaylist Get a playlist.
 ...
 @return ApiGetPlaylistRequest
*/
func (a *PlaylistAPIService) GetPlaylist(ctx context.Context, playlistId string) ApiGetPlaylistRequest {
	return ApiGetPlaylistRequest{
		ApiService: a,
		ctx: ctx,
		playlistId: playlistId,
...
// Execute executes the request
//  @return PlaylistDto
func (a *PlaylistAPIService) GetPlaylistExecute(r ApiGetPlaylistRequest) (*PlaylistDto, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "PlaylistAPIService.GetPlaylist")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
GetPlaylistItems Gets the original items of a playlist.
 ...
 @return ApiGetPlaylistItemsRequest
*/
func (a *PlaylistAPIService) GetPlaylistItems(ctx context.Context, playlistId string) ApiGetPlaylistItemsRequest {
	return ApiGetPlaylistItemsRequest{
		ApiService: a,
		ctx: ctx,
		playlistId: playlistId,
...
// Execute executes the request
//  @return BaseItemDtoQueryResult
func (a *PlaylistAPIService) GetPlaylistItemsExecute(r ApiGetPlaylistItemsRequest) (*BaseItemDtoQueryResult, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "PlaylistAPIService.GetPlaylistItems")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
GetPlaylistUser Get a playlist user.
 ...
 @return ApiGetPlaylistUserRequest
*/
func (a *PlaylistAPIService) GetPlaylistUser(ctx context.Context, playlistId string, userId string) ApiGetPlaylistUserRequest {
	return ApiGetPlaylistUserRequest{
		ApiService: a,
		ctx: ctx,
		playlistId: playlistId,
...
// Execute executes the request
//  @return PlaylistUserPermissions
func (a *PlaylistAPIService) GetPlaylistUserExecute(r ApiGetPlaylistUserRequest) (*PlaylistUserPermissions, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "PlaylistAPIService.GetPlaylistUser")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
GetPlaylistUsers Get a playlist's users.
 ...
 @return ApiGetPlaylistUsersRequest
*/
func (a *PlaylistAPIService) GetPlaylistUsers(ctx context.Context, playlistId string) ApiGetPlaylistUsersRequest {
	return ApiGetPlaylistUsersRequest{
		ApiService: a,
		ctx: ctx,
		playlistId: playlistId,
...
// Execute executes the request
//  @return []PlaylistUserPermissions
func (a *PlaylistAPIService) GetPlaylistUsersExecute(r ApiGetPlaylistUsersRequest) ([]PlaylistUserPermissions, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "PlaylistAPIService.GetPlaylistUsers")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
MoveItem Moves a playlist item.
 ...
 @return ApiMoveItemRequest
*/
func (a *PlaylistAPIService) MoveItem(ctx context.Context, playlistId string, itemId string, newIndex int32) ApiMoveItemRequest {
	return ApiMoveItemRequest{
		ApiService: a,
		ctx: ctx,
		playlistId: playlistId,
...
// Execute executes the request
func (a *PlaylistAPIService) MoveItemExecute(r ApiMoveItemRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "PlaylistAPIService.MoveItem")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}
...
RemoveItemFromPlaylist Removes items from a playlist.
 ...
 @return ApiRemoveItemFromPlaylistRequest
*/
func (a *PlaylistAPIService) RemoveItemFromPlaylist(ctx context.Context, playlistId string) ApiRemoveItemFromPlaylistRequest {
	return ApiRemoveItemFromPlaylistRequest{
		ApiService: a,
		ctx: ctx,
		playlistId: playlistId,
...
// Execute executes the request
func (a *PlaylistAPIService) RemoveItemFromPlaylistExecute(r ApiRemoveItemFromPlaylistRequest) (*http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "PlaylistAPIService.RemoveItemFromPlaylist")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}
...
RemoveUserFromPlaylist Remove a user from a playlist's users.
 ...
 @return ApiRemoveUserFromPlaylistRequest
*/
func (a *PlaylistAPIService) RemoveUserFromPlaylist(ctx context.Context, playlistId string, userId string) ApiRemoveUserFromPlaylistRequest {
	return ApiRemoveUserFromPlaylistRequest{
		ApiService: a,
		ctx: ctx,
		playlistId: playlistId,
...
// Execute executes the request
func (a *PlaylistAPIService) RemoveUserFromPlaylistExecute(r ApiRemoveUserFromPlaylistRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodDelete
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "PlaylistAPIService.RemoveUserFromPlaylist")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}
...
UpdatePlaylist Updates a playlist.
 ...
 @return ApiUpdatePlaylistRequest
*/
func (a *PlaylistAPIService) UpdatePlaylist(ctx context.Context, playlistId string) ApiUpdatePlaylistRequest {
	return ApiUpdatePlaylistRequest{
		ApiService: a,
		ctx: ctx,
		playlistId: playlistId,
...
// Execute executes the request
func (a *PlaylistAPIService) UpdatePlaylistExecute(r ApiUpdatePlaylistRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "PlaylistAPIService.UpdatePlaylist")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}
...
UpdatePlaylistUser Modify a user of a playlist's users.
 ...
 @return ApiUpdatePlaylistUserRequest
*/
func (a *PlaylistAPIService) UpdatePlaylistUser(ctx context.Context, playlistId string, userId string) ApiUpdatePlaylistUserRequest {
	return ApiUpdatePlaylistUserRequest{
		ApiService: a,
		ctx: ctx,
		playlistId: playlistId,
...
// Execute executes the request
func (a *PlaylistAPIService) UpdatePlaylistUserExecute(r ApiUpdatePlaylistUserRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "PlaylistAPIService.UpdatePlaylistUser")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

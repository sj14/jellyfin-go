...
type InstantMixAPI interface {
	...
	*/
	GetInstantMixFromAlbum(ctx context.Context, id string) ApiGetInstantMixFromAlbumRequest
	...
	*/
	GetInstantMixFromArtists(ctx context.Context, id string) ApiGetInstantMixFromArtistsRequest
	...
	*/
	GetInstantMixFromItem(ctx context.Context, id string) ApiGetInstantMixFromItemRequest
	...
	*/
	GetInstantMixFromPlaylist(ctx context.Context, id string) ApiGetInstantMixFromPlaylistRequest
	...
	*/
	GetInstantMixFromSong(ctx context.Context, id string) ApiGetInstantMixFromSongRequest
...
GetInstantMixFromAlbum Creates an instant playlist based on a given album.
 ...
 @return ApiGetInstantMixFromAlbumRequest
*/
func (a *InstantMixAPIService) GetInstantMixFromAlbum(ctx context.Context, id string) ApiGetInstantMixFromAlbumRequest {
	return ApiGetInstantMixFromAlbumRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
GetInstantMixFromArtists Creates an instant playlist based on a given artist.
 ...
 @return ApiGetInstantMixFromArtistsRequest
*/
func (a *InstantMixAPIService) GetInstantMixFromArtists(ctx context.Context, id string) ApiGetInstantMixFromArtistsRequest {
	return ApiGetInstantMixFromArtistsRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
func (a *InstantMixAPIService) GetInstantMixFromArtistsExecute(r ApiGetInstantMixFromArtistsRequest) (*BaseItemDtoQueryResult, *http.Response, error) {
	...
	localVarPath := localBasePath + "/Artists/{id}/InstantMix"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", url.PathEscape(parameterValueToString(r.id, "id")), -1)
...
GetInstantMixFromItem Creates an instant playlist based on a given item.
 ...
 @return ApiGetInstantMixFromItemRequest
*/
func (a *InstantMixAPIService) GetInstantMixFromItem(ctx context.Context, id string) ApiGetInstantMixFromItemRequest {
	return ApiGetInstantMixFromItemRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
GetInstantMixFromPlaylist Creates an instant playlist based on a given playlist.
 ...
 @return ApiGetInstantMixFromPlaylistRequest
*/
func (a *InstantMixAPIService) GetInstantMixFromPlaylist(ctx context.Context, id string) ApiGetInstantMixFromPlaylistRequest {
	return ApiGetInstantMixFromPlaylistRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
GetInstantMixFromSong Creates an instant playlist based on a given song.
 ...
 @return ApiGetInstantMixFromSongRequest
*/
func (a *InstantMixAPIService) GetInstantMixFromSong(ctx context.Context, id string) ApiGetInstantMixFromSongRequest {
	return ApiGetInstantMixFromSongRequest{
		ApiService: a,
		ctx: ctx,
		id: id,

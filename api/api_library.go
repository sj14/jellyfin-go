...
func (r ApiGetLibraryOptionsInfoRequest) LibraryContentType(libraryContentType string) ApiGetLibraryOptionsInfoRequest {
...
func (a *LibraryAPIService) GetLibraryOptionsInfoExecute(r ApiGetLibraryOptionsInfoRequest) (*LibraryOptionsResultDto, *http.Response, error) {
	...
	if r.libraryContentType != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "libraryContentType", r.libraryContentType, "")
	}
	if r.isNewLibrary != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "isNewLibrary", r.isNewLibrary, "")
	} else {

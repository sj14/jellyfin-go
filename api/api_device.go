...
DeleteDevice Deletes devices.
 ...
 @return ApiDeleteDeviceRequest
*/
func (a *DeviceAPIService) DeleteDevice(ctx context.Context) ApiDeleteDeviceRequest {
	return ApiDeleteDeviceRequest{
		ApiService: a,
		ctx: ctx,
	}
...
GetDeviceInfo Get info for a device.
 ...
 @return ApiGetDeviceInfoRequest
*/
func (a *DeviceAPIService) GetDeviceInfo(ctx context.Context) ApiGetDeviceInfoRequest {
	return ApiGetDeviceInfoRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return DeviceInfoDto
func (a *DeviceAPIService) GetDeviceInfoExecute(r ApiGetDeviceInfoRequest) (*DeviceInfoDto, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DeviceAPIService.GetDeviceInfo")
	if err != nil {
...
GetDeviceOptions Get options for a device.
 ...
 @return ApiGetDeviceOptionsRequest
*/
func (a *DeviceAPIService) GetDeviceOptions(ctx context.Context) ApiGetDeviceOptionsRequest {
	return ApiGetDeviceOptionsRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return DeviceOptionsDto
func (a *DeviceAPIService) GetDeviceOptionsExecute(r ApiGetDeviceOptionsRequest) (*DeviceOptionsDto, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DeviceAPIService.GetDeviceOptions")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
// Execute executes the request
//  @return DeviceInfoDtoQueryResult
func (a *DeviceAPIService) GetDevicesExecute(r ApiGetDevicesRequest) (*DeviceInfoDtoQueryResult, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
UpdateDeviceOptions Update device options.
 ...
 @return ApiUpdateDeviceOptionsRequest
*/
func (a *DeviceAPIService) UpdateDeviceOptions(ctx context.Context) ApiUpdateDeviceOptionsRequest {
	return ApiUpdateDeviceOptionsRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
func (a *DeviceAPIService) UpdateDeviceOptionsExecute(r ApiUpdateDeviceOptionsRequest) (*http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DeviceAPIService.UpdateDeviceOptions")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

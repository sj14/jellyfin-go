...
// ShowAPIService ShowAPI service
type ShowAPIService service
...
GetEpisodes Gets episodes for a tv season.
 ...
 @return ApiGetEpisodesRequest
*/
func (a *ShowAPIService) GetEpisodes(ctx context.Context, seriesId string) ApiGetEpisodesRequest {
	return ApiGetEpisodesRequest{
		ApiService: a,
		ctx: ctx,
		seriesId: seriesId,
...
//  @return BaseItemDtoQueryResult
func (a *ShowAPIService) GetEpisodesExecute(r ApiGetEpisodesRequest) (*BaseItemDtoQueryResult, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ShowAPIService.GetEpisodes")
	if err != nil {
...
GetNextUp Gets a list of next up episodes.
 ...
 @return ApiGetNextUpRequest
*/
func (a *ShowAPIService) GetNextUp(ctx context.Context) ApiGetNextUpRequest {
	return ApiGetNextUpRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return BaseItemDtoQueryResult
func (a *ShowAPIService) GetNextUpExecute(r ApiGetNextUpRequest) (*BaseItemDtoQueryResult, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ShowAPIService.GetNextUp")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
	...
	if r.enableResumable != nil {
		...
		var defaultValue bool = true
		parameterAddToHeaderOrQuery(localVarQueryParams, "enableResumable", defaultValue, "form", "")
	...
	if r.enableRewatching != nil {
		...
		parameterAddToHeaderOrQuery(localVarQueryParams, "enableRewatching", defaultValue, "form", "")
...
GetSeasons Gets seasons for a tv series.
 ...
 @return ApiGetSeasonsRequest
*/
func (a *ShowAPIService) GetSeasons(ctx context.Context, seriesId string) ApiGetSeasonsRequest {
	return ApiGetSeasonsRequest{
		ApiService: a,
		ctx: ctx,
		seriesId: seriesId,
...
// Execute executes the request
//  @return BaseItemDtoQueryResult
func (a *ShowAPIService) GetSeasonsExecute(r ApiGetSeasonsRequest) (*BaseItemDtoQueryResult, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ShowAPIService.GetSeasons")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
GetUpcomingEpisodes Gets a list of upcoming episodes.
 ...
 @return ApiGetUpcomingEpisodesRequest
*/
func (a *ShowAPIService) GetUpcomingEpisodes(ctx context.Context) ApiGetUpcomingEpisodesRequest {
	return ApiGetUpcomingEpisodesRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return BaseItemDtoQueryResult
func (a *ShowAPIService) GetUpcomingEpisodesExecute(r ApiGetUpcomingEpisodesRequest) (*BaseItemDtoQueryResult, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ShowAPIService.GetUpcomingEpisodes")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

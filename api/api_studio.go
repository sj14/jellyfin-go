...
// StudioAPIService StudioAPI service
type StudioAPIService service

type ApiGetStudioRequest struct {
	ctx context.Context
	ApiService StudioAPI
	name string
	userId *string
}
...
GetStudio Gets a studio by name.
 ...
 @return ApiGetStudioRequest
*/
func (a *StudioAPIService) GetStudio(ctx context.Context, name string) ApiGetStudioRequest {
	return ApiGetStudioRequest{
		ApiService: a,
		ctx: ctx,
		name: name,
...
//  @return BaseItemDto
func (a *StudioAPIService) GetStudioExecute(r ApiGetStudioRequest) (*BaseItemDto, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "StudioAPIService.GetStudio")
	if err != nil {
...
GetStudios Gets all studios from a given item, folder, or the entire library.
 ...
 @return ApiGetStudiosRequest
*/
func (a *StudioAPIService) GetStudios(ctx context.Context) ApiGetStudiosRequest {
	return ApiGetStudiosRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return BaseItemDtoQueryResult
func (a *StudioAPIService) GetStudiosExecute(r ApiGetStudiosRequest) (*BaseItemDtoQueryResult, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "StudioAPIService.GetStudios")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

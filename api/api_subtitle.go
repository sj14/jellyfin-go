...
type SubtitleAPI interface {
	...
	*/
	GetRemoteSubtitles(ctx context.Context, id string) ApiGetRemoteSubtitlesRequest
...
GetRemoteSubtitles Gets the remote subtitles.
 ...
 @return ApiGetRemoteSubtitlesRequest
*/
func (a *SubtitleAPIService) GetRemoteSubtitles(ctx context.Context, id string) ApiGetRemoteSubtitlesRequest {
	return ApiGetRemoteSubtitlesRequest{
		ApiService: a,
		ctx: ctx,
		id: id,

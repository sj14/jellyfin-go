...
type ItemsAPI interface {
	...
	*/
	...
	@return ApiGetItemsByUserIdRequest
	*/
	GetItemsByUserId(ctx context.Context, userId string) ApiGetItemsByUserIdRequest

	// GetItemsByUserIdExecute executes the request
	//  @return BaseItemDtoQueryResult
	GetItemsByUserIdExecute(r ApiGetItemsByUserIdRequest) (*BaseItemDtoQueryResult, *http.Response, error)
	...
	*/
	GetResumeItems(ctx context.Context, userId string) ApiGetResumeItemsRequest
...
type ApiGetItemsByUserIdRequest struct {
	ctx context.Context
	ApiService ItemsAPI
	userId string
	maxOfficialRating *string
...
// Optional filter by maximum official rating (PG, PG-13, TV-MA, etc).
func (r ApiGetItemsByUserIdRequest) MaxOfficialRating(maxOfficialRating string) ApiGetItemsByUserIdRequest {
	r.maxOfficialRating = &maxOfficialRating
	return r
}

// Optional filter by items with theme songs.
func (r ApiGetItemsByUserIdRequest) HasThemeSong(hasThemeSong bool) ApiGetItemsByUserIdRequest {
	r.hasThemeSong = &hasThemeSong
	return r
}

// Optional filter by items with theme videos.
func (r ApiGetItemsByUserIdRequest) HasThemeVideo(hasThemeVideo bool) ApiGetItemsByUserIdRequest {
	r.hasThemeVideo = &hasThemeVideo
	return r
}

// Optional filter by items with subtitles.
func (r ApiGetItemsByUserIdRequest) HasSubtitles(hasSubtitles bool) ApiGetItemsByUserIdRequest {
	r.hasSubtitles = &hasSubtitles
	return r
}

// Optional filter by items with special features.
func (r ApiGetItemsByUserIdRequest) HasSpecialFeature(hasSpecialFeature bool) ApiGetItemsByUserIdRequest {
	r.hasSpecialFeature = &hasSpecialFeature
	return r
}

// Optional filter by items with trailers.
func (r ApiGetItemsByUserIdRequest) HasTrailer(hasTrailer bool) ApiGetItemsByUserIdRequest {
	r.hasTrailer = &hasTrailer
	return r
}

// Optional. Return items that are siblings of a supplied item.
func (r ApiGetItemsByUserIdRequest) AdjacentTo(adjacentTo string) ApiGetItemsByUserIdRequest {
	r.adjacentTo = &adjacentTo
	return r
}

// Optional filter by parent index number.
func (r ApiGetItemsByUserIdRequest) ParentIndexNumber(parentIndexNumber int32) ApiGetItemsByUserIdRequest {
	r.parentIndexNumber = &parentIndexNumber
	return r
}

// Optional filter by items that have or do not have a parental rating.
func (r ApiGetItemsByUserIdRequest) HasParentalRating(hasParentalRating bool) ApiGetItemsByUserIdRequest {
	r.hasParentalRating = &hasParentalRating
	return r
}

// Optional filter by items that are HD or not.
func (r ApiGetItemsByUserIdRequest) IsHd(isHd bool) ApiGetItemsByUserIdRequest {
	r.isHd = &isHd
	return r
}

// Optional filter by items that are 4K or not.
func (r ApiGetItemsByUserIdRequest) Is4K(is4K bool) ApiGetItemsByUserIdRequest {
	r.is4K = &is4K
	return r
}

// Optional. If specified, results will be filtered based on LocationType. This allows multiple, comma delimited.
func (r ApiGetItemsByUserIdRequest) LocationTypes(locationTypes []LocationType) ApiGetItemsByUserIdRequest {
	r.locationTypes = &locationTypes
	return r
}

// Optional. If specified, results will be filtered based on the LocationType. This allows multiple, comma delimited.
func (r ApiGetItemsByUserIdRequest) ExcludeLocationTypes(excludeLocationTypes []LocationType) ApiGetItemsByUserIdRequest {
	r.excludeLocationTypes = &excludeLocationTypes
	return r
}

// Optional filter by items that are missing episodes or not.
func (r ApiGetItemsByUserIdRequest) IsMissing(isMissing bool) ApiGetItemsByUserIdRequest {
	r.isMissing = &isMissing
	return r
}

// Optional filter by items that are unaired episodes or not.
func (r ApiGetItemsByUserIdRequest) IsUnaired(isUnaired bool) ApiGetItemsByUserIdRequest {
	r.isUnaired = &isUnaired
	return r
}

// Optional filter by minimum community rating.
func (r ApiGetItemsByUserIdRequest) MinCommunityRating(minCommunityRating float64) ApiGetItemsByUserIdRequest {
	r.minCommunityRating = &minCommunityRating
	return r
}

// Optional filter by minimum critic rating.
func (r ApiGetItemsByUserIdRequest) MinCriticRating(minCriticRating float64) ApiGetItemsByUserIdRequest {
	r.minCriticRating = &minCriticRating
	return r
}

// Optional. The minimum premiere date. Format &#x3D; ISO.
func (r ApiGetItemsByUserIdRequest) MinPremiereDate(minPremiereDate time.Time) ApiGetItemsByUserIdRequest {
	r.minPremiereDate = &minPremiereDate
	return r
}

// Optional. The minimum last saved date. Format &#x3D; ISO.
func (r ApiGetItemsByUserIdRequest) MinDateLastSaved(minDateLastSaved time.Time) ApiGetItemsByUserIdRequest {
	r.minDateLastSaved = &minDateLastSaved
	return r
}

// Optional. The minimum last saved date for the current user. Format &#x3D; ISO.
func (r ApiGetItemsByUserIdRequest) MinDateLastSavedForUser(minDateLastSavedForUser time.Time) ApiGetItemsByUserIdRequest {
	r.minDateLastSavedForUser = &minDateLastSavedForUser
	return r
}

// Optional. The maximum premiere date. Format &#x3D; ISO.
func (r ApiGetItemsByUserIdRequest) MaxPremiereDate(maxPremiereDate time.Time) ApiGetItemsByUserIdRequest {
	r.maxPremiereDate = &maxPremiereDate
	return r
}

// Optional filter by items that have an overview or not.
func (r ApiGetItemsByUserIdRequest) HasOverview(hasOverview bool) ApiGetItemsByUserIdRequest {
	r.hasOverview = &hasOverview
	return r
}

// Optional filter by items that have an imdb id or not.
func (r ApiGetItemsByUserIdRequest) HasImdbId(hasImdbId bool) ApiGetItemsByUserIdRequest {
	r.hasImdbId = &hasImdbId
	return r
}

// Optional filter by items that have a tmdb id or not.
func (r ApiGetItemsByUserIdRequest) HasTmdbId(hasTmdbId bool) ApiGetItemsByUserIdRequest {
	r.hasTmdbId = &hasTmdbId
	return r
}

// Optional filter by items that have a tvdb id or not.
func (r ApiGetItemsByUserIdRequest) HasTvdbId(hasTvdbId bool) ApiGetItemsByUserIdRequest {
	r.hasTvdbId = &hasTvdbId
	return r
}

// Optional filter for live tv movies.
func (r ApiGetItemsByUserIdRequest) IsMovie(isMovie bool) ApiGetItemsByUserIdRequest {
	r.isMovie = &isMovie
	return r
}

// Optional filter for live tv series.
func (r ApiGetItemsByUserIdRequest) IsSeries(isSeries bool) ApiGetItemsByUserIdRequest {
	r.isSeries = &isSeries
	return r
}

// Optional filter for live tv news.
func (r ApiGetItemsByUserIdRequest) IsNews(isNews bool) ApiGetItemsByUserIdRequest {
	r.isNews = &isNews
	return r
}

// Optional filter for live tv kids.
func (r ApiGetItemsByUserIdRequest) IsKids(isKids bool) ApiGetItemsByUserIdRequest {
	r.isKids = &isKids
	return r
}

// Optional filter for live tv sports.
func (r ApiGetItemsByUserIdRequest) IsSports(isSports bool) ApiGetItemsByUserIdRequest {
	r.isSports = &isSports
	return r
}

// Optional. If specified, results will be filtered by excluding item ids. This allows multiple, comma delimited.
func (r ApiGetItemsByUserIdRequest) ExcludeItemIds(excludeItemIds []string) ApiGetItemsByUserIdRequest {
	r.excludeItemIds = &excludeItemIds
	return r
}

// Optional. The record index to start at. All items with a lower index will be dropped from the results.
func (r ApiGetItemsByUserIdRequest) StartIndex(startIndex int32) ApiGetItemsByUserIdRequest {
	r.startIndex = &startIndex
	return r
}

// Optional. The maximum number of records to return.
func (r ApiGetItemsByUserIdRequest) Limit(limit int32) ApiGetItemsByUserIdRequest {
	r.limit = &limit
	return r
}

// When searching within folders, this determines whether or not the search will be recursive. true/false.
func (r ApiGetItemsByUserIdRequest) Recursive(recursive bool) ApiGetItemsByUserIdRequest {
	r.recursive = &recursive
	return r
}

// Optional. Filter based on a search term.
func (r ApiGetItemsByUserIdRequest) SearchTerm(searchTerm string) ApiGetItemsByUserIdRequest {
	r.searchTerm = &searchTerm
	return r
}

// Sort Order - Ascending,Descending.
func (r ApiGetItemsByUserIdRequest) SortOrder(sortOrder []SortOrder) ApiGetItemsByUserIdRequest {
	r.sortOrder = &sortOrder
	return r
}

// Specify this to localize the search to a specific item or folder. Omit to use the root.
func (r ApiGetItemsByUserIdRequest) ParentId(parentId string) ApiGetItemsByUserIdRequest {
	r.parentId = &parentId
	return r
}

// Optional. Specify additional fields of information to return in the output. This allows multiple, comma delimited. Options: Budget, Chapters, DateCreated, Genres, HomePageUrl, IndexOptions, MediaStreams, Overview, ParentId, Path, People, ProviderIds, PrimaryImageAspectRatio, Revenue, SortName, Studios, Taglines.
func (r ApiGetItemsByUserIdRequest) Fields(fields []ItemFields) ApiGetItemsByUserIdRequest {
	r.fields = &fields
	return r
}

// Optional. If specified, results will be filtered based on item type. This allows multiple, comma delimited.
func (r ApiGetItemsByUserIdRequest) ExcludeItemTypes(excludeItemTypes []BaseItemKind) ApiGetItemsByUserIdRequest {
	r.excludeItemTypes = &excludeItemTypes
	return r
}

// Optional. If specified, results will be filtered based on the item type. This allows multiple, comma delimited.
func (r ApiGetItemsByUserIdRequest) IncludeItemTypes(includeItemTypes []BaseItemKind) ApiGetItemsByUserIdRequest {
	r.includeItemTypes = &includeItemTypes
	return r
}

// Optional. Specify additional filters to apply. This allows multiple, comma delimited. Options: IsFolder, IsNotFolder, IsUnplayed, IsPlayed, IsFavorite, IsResumable, Likes, Dislikes.
func (r ApiGetItemsByUserIdRequest) Filters(filters []ItemFilter) ApiGetItemsByUserIdRequest {
	r.filters = &filters
	return r
}

// Optional filter by items that are marked as favorite, or not.
func (r ApiGetItemsByUserIdRequest) IsFavorite(isFavorite bool) ApiGetItemsByUserIdRequest {
	r.isFavorite = &isFavorite
	return r
}

// Optional filter by MediaType. Allows multiple, comma delimited.
func (r ApiGetItemsByUserIdRequest) MediaTypes(mediaTypes []string) ApiGetItemsByUserIdRequest {
	r.mediaTypes = &mediaTypes
	return r
}

// Optional. If specified, results will be filtered based on those containing image types. This allows multiple, comma delimited.
func (r ApiGetItemsByUserIdRequest) ImageTypes(imageTypes []ImageType) ApiGetItemsByUserIdRequest {
	r.imageTypes = &imageTypes
	return r
}

// Optional. Specify one or more sort orders, comma delimited. Options: Album, AlbumArtist, Artist, Budget, CommunityRating, CriticRating, DateCreated, DatePlayed, PlayCount, PremiereDate, ProductionYear, SortName, Random, Revenue, Runtime.
func (r ApiGetItemsByUserIdRequest) SortBy(sortBy []string) ApiGetItemsByUserIdRequest {
	r.sortBy = &sortBy
	return r
}

// Optional filter by items that are played, or not.
func (r ApiGetItemsByUserIdRequest) IsPlayed(isPlayed bool) ApiGetItemsByUserIdRequest {
	r.isPlayed = &isPlayed
	return r
}

// Optional. If specified, results will be filtered based on genre. This allows multiple, pipe delimited.
func (r ApiGetItemsByUserIdRequest) Genres(genres []string) ApiGetItemsByUserIdRequest {
	r.genres = &genres
	return r
}

// Optional. If specified, results will be filtered based on OfficialRating. This allows multiple, pipe delimited.
func (r ApiGetItemsByUserIdRequest) OfficialRatings(officialRatings []string) ApiGetItemsByUserIdRequest {
	r.officialRatings = &officialRatings
	return r
}

// Optional. If specified, results will be filtered based on tag. This allows multiple, pipe delimited.
func (r ApiGetItemsByUserIdRequest) Tags(tags []string) ApiGetItemsByUserIdRequest {
	r.tags = &tags
	return r
}

// Optional. If specified, results will be filtered based on production year. This allows multiple, comma delimited.
func (r ApiGetItemsByUserIdRequest) Years(years []int32) ApiGetItemsByUserIdRequest {
	r.years = &years
	return r
}

// Optional, include user data.
func (r ApiGetItemsByUserIdRequest) EnableUserData(enableUserData bool) ApiGetItemsByUserIdRequest {
	r.enableUserData = &enableUserData
	return r
}

// Optional, the max number of images to return, per image type.
func (r ApiGetItemsByUserIdRequest) ImageTypeLimit(imageTypeLimit int32) ApiGetItemsByUserIdRequest {
	r.imageTypeLimit = &imageTypeLimit
	return r
}

// Optional. The image types to include in the output.
func (r ApiGetItemsByUserIdRequest) EnableImageTypes(enableImageTypes []ImageType) ApiGetItemsByUserIdRequest {
	r.enableImageTypes = &enableImageTypes
	return r
}

// Optional. If specified, results will be filtered to include only those containing the specified person.
func (r ApiGetItemsByUserIdRequest) Person(person string) ApiGetItemsByUserIdRequest {
	r.person = &person
	return r
}

// Optional. If specified, results will be filtered to include only those containing the specified person id.
func (r ApiGetItemsByUserIdRequest) PersonIds(personIds []string) ApiGetItemsByUserIdRequest {
	r.personIds = &personIds
	return r
}

// Optional. If specified, along with Person, results will be filtered to include only those containing the specified person and PersonType. Allows multiple, comma-delimited.
func (r ApiGetItemsByUserIdRequest) PersonTypes(personTypes []string) ApiGetItemsByUserIdRequest {
	r.personTypes = &personTypes
	return r
}

// Optional. If specified, results will be filtered based on studio. This allows multiple, pipe delimited.
func (r ApiGetItemsByUserIdRequest) Studios(studios []string) ApiGetItemsByUserIdRequest {
	r.studios = &studios
	return r
}

// Optional. If specified, results will be filtered based on artists. This allows multiple, pipe delimited.
func (r ApiGetItemsByUserIdRequest) Artists(artists []string) ApiGetItemsByUserIdRequest {
	r.artists = &artists
	return r
}

// Optional. If specified, results will be filtered based on artist id. This allows multiple, pipe delimited.
func (r ApiGetItemsByUserIdRequest) ExcludeArtistIds(excludeArtistIds []string) ApiGetItemsByUserIdRequest {
	r.excludeArtistIds = &excludeArtistIds
	return r
}

// Optional. If specified, results will be filtered to include only those containing the specified artist id.
func (r ApiGetItemsByUserIdRequest) ArtistIds(artistIds []string) ApiGetItemsByUserIdRequest {
	r.artistIds = &artistIds
	return r
}

// Optional. If specified, results will be filtered to include only those containing the specified album artist id.
func (r ApiGetItemsByUserIdRequest) AlbumArtistIds(albumArtistIds []string) ApiGetItemsByUserIdRequest {
	r.albumArtistIds = &albumArtistIds
	return r
}

// Optional. If specified, results will be filtered to include only those containing the specified contributing artist id.
func (r ApiGetItemsByUserIdRequest) ContributingArtistIds(contributingArtistIds []string) ApiGetItemsByUserIdRequest {
	r.contributingArtistIds = &contributingArtistIds
	return r
}

// Optional. If specified, results will be filtered based on album. This allows multiple, pipe delimited.
func (r ApiGetItemsByUserIdRequest) Albums(albums []string) ApiGetItemsByUserIdRequest {
	r.albums = &albums
	return r
}

// Optional. If specified, results will be filtered based on album id. This allows multiple, pipe delimited.
func (r ApiGetItemsByUserIdRequest) AlbumIds(albumIds []string) ApiGetItemsByUserIdRequest {
	r.albumIds = &albumIds
	return r
}

// Optional. If specific items are needed, specify a list of item id&#39;s to retrieve. This allows multiple, comma delimited.
func (r ApiGetItemsByUserIdRequest) Ids(ids []string) ApiGetItemsByUserIdRequest {
	r.ids = &ids
	return r
}

// Optional filter by VideoType (videofile, dvd, bluray, iso). Allows multiple, comma delimited.
func (r ApiGetItemsByUserIdRequest) VideoTypes(videoTypes []VideoType) ApiGetItemsByUserIdRequest {
	r.videoTypes = &videoTypes
	return r
}

// Optional filter by minimum official rating (PG, PG-13, TV-MA, etc).
func (r ApiGetItemsByUserIdRequest) MinOfficialRating(minOfficialRating string) ApiGetItemsByUserIdRequest {
	r.minOfficialRating = &minOfficialRating
	return r
}

// Optional filter by items that are locked.
func (r ApiGetItemsByUserIdRequest) IsLocked(isLocked bool) ApiGetItemsByUserIdRequest {
	r.isLocked = &isLocked
	return r
}

// Optional filter by items that are placeholders.
func (r ApiGetItemsByUserIdRequest) IsPlaceHolder(isPlaceHolder bool) ApiGetItemsByUserIdRequest {
	r.isPlaceHolder = &isPlaceHolder
	return r
}

// Optional filter by items that have official ratings.
func (r ApiGetItemsByUserIdRequest) HasOfficialRating(hasOfficialRating bool) ApiGetItemsByUserIdRequest {
	r.hasOfficialRating = &hasOfficialRating
	return r
}

// Whether or not to hide items behind their boxsets.
func (r ApiGetItemsByUserIdRequest) CollapseBoxSetItems(collapseBoxSetItems bool) ApiGetItemsByUserIdRequest {
	r.collapseBoxSetItems = &collapseBoxSetItems
	return r
}

// Optional. Filter by the minimum width of the item.
func (r ApiGetItemsByUserIdRequest) MinWidth(minWidth int32) ApiGetItemsByUserIdRequest {
	r.minWidth = &minWidth
	return r
}

// Optional. Filter by the minimum height of the item.
func (r ApiGetItemsByUserIdRequest) MinHeight(minHeight int32) ApiGetItemsByUserIdRequest {
	r.minHeight = &minHeight
	return r
}

// Optional. Filter by the maximum width of the item.
func (r ApiGetItemsByUserIdRequest) MaxWidth(maxWidth int32) ApiGetItemsByUserIdRequest {
	r.maxWidth = &maxWidth
	return r
}

// Optional. Filter by the maximum height of the item.
func (r ApiGetItemsByUserIdRequest) MaxHeight(maxHeight int32) ApiGetItemsByUserIdRequest {
	r.maxHeight = &maxHeight
	return r
}

// Optional filter by items that are 3D, or not.
func (r ApiGetItemsByUserIdRequest) Is3D(is3D bool) ApiGetItemsByUserIdRequest {
	r.is3D = &is3D
	return r
}

// Optional filter by Series Status. Allows multiple, comma delimited.
func (r ApiGetItemsByUserIdRequest) SeriesStatus(seriesStatus []SeriesStatus) ApiGetItemsByUserIdRequest {
	r.seriesStatus = &seriesStatus
	return r
}

// Optional filter by items whose name is sorted equally or greater than a given input string.
func (r ApiGetItemsByUserIdRequest) NameStartsWithOrGreater(nameStartsWithOrGreater string) ApiGetItemsByUserIdRequest {
	r.nameStartsWithOrGreater = &nameStartsWithOrGreater
	return r
}

// Optional filter by items whose name is sorted equally than a given input string.
func (r ApiGetItemsByUserIdRequest) NameStartsWith(nameStartsWith string) ApiGetItemsByUserIdRequest {
	r.nameStartsWith = &nameStartsWith
	return r
}

// Optional filter by items whose name is equally or lesser than a given input string.
func (r ApiGetItemsByUserIdRequest) NameLessThan(nameLessThan string) ApiGetItemsByUserIdRequest {
	r.nameLessThan = &nameLessThan
	return r
}

// Optional. If specified, results will be filtered based on studio id. This allows multiple, pipe delimited.
func (r ApiGetItemsByUserIdRequest) StudioIds(studioIds []string) ApiGetItemsByUserIdRequest {
	r.studioIds = &studioIds
	return r
}

// Optional. If specified, results will be filtered based on genre id. This allows multiple, pipe delimited.
func (r ApiGetItemsByUserIdRequest) GenreIds(genreIds []string) ApiGetItemsByUserIdRequest {
	r.genreIds = &genreIds
	return r
}

// Optional. Enable the total record count.
func (r ApiGetItemsByUserIdRequest) EnableTotalRecordCount(enableTotalRecordCount bool) ApiGetItemsByUserIdRequest {
	r.enableTotalRecordCount = &enableTotalRecordCount
	return r
}

// Optional, include image information in output.
func (r ApiGetItemsByUserIdRequest) EnableImages(enableImages bool) ApiGetItemsByUserIdRequest {
	r.enableImages = &enableImages
	return r
}

func (r ApiGetItemsByUserIdRequest) Execute() (*BaseItemDtoQueryResult, *http.Response, error) {
	return r.ApiService.GetItemsByUserIdExecute(r)
}
...
GetItemsByUserId Gets items based on a query.
 ...
 @return ApiGetItemsByUserIdRequest
*/
func (a *ItemsAPIService) GetItemsByUserId(ctx context.Context, userId string) ApiGetItemsByUserIdRequest {
	return ApiGetItemsByUserIdRequest{
		ApiService: a,
		ctx: ctx,
		userId: userId,
...
// Execute executes the request
//  @return BaseItemDtoQueryResult
func (a *ItemsAPIService) GetItemsByUserIdExecute(r ApiGetItemsByUserIdRequest) (*BaseItemDtoQueryResult, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ItemsAPIService.GetItemsByUserId")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
// Optional. Filter by MediaType. Allows multiple, comma delimited.
func (r ApiGetResumeItemsRequest) MediaTypes(mediaTypes []string) ApiGetResumeItemsRequest {
	r.mediaTypes = &mediaTypes
	return r
}
...
GetResumeItems Gets items based on a query.
 ...
 @return ApiGetResumeItemsRequest
*/
func (a *ItemsAPIService) GetResumeItems(ctx context.Context, userId string) ApiGetResumeItemsRequest {
	return ApiGetResumeItemsRequest{
		ApiService: a,
		ctx: ctx,
		userId: userId,

...
type UserPolicy struct {
	...
	MaxParentalSubRating NullableInt32 `json:"MaxParentalSubRating,omitempty"`
...
// GetMaxParentalSubRating returns the MaxParentalSubRating field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *UserPolicy) GetMaxParentalSubRating() int32 {
	if o == nil || IsNil(o.MaxParentalSubRating.Get()) {
		var ret int32
		return ret
	}
	return *o.MaxParentalSubRating.Get()
}

// GetMaxParentalSubRatingOk returns a tuple with the MaxParentalSubRating field value if set, nil otherwise
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
...
// SetMaxParentalSubRating gets a reference to the given NullableInt32 and assigns it to the MaxParentalSubRating field.
func (o *UserPolicy) SetMaxParentalSubRating(v int32) {
	o.MaxParentalSubRating.Set(&v)
}
// SetMaxParentalSubRatingNil sets the value for MaxParentalSubRating to be an explicit nil
func (o *UserPolicy) SetMaxParentalSubRatingNil() {
	o.MaxParentalSubRating.Set(nil)
}
...
func (o UserPolicy) ToMap() (map[string]interface{}, error) {
	...
	if o.MaxParentalSubRating.IsSet() {
		toSerialize["MaxParentalSubRating"] = o.MaxParentalSubRating.Get()
	}

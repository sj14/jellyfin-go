...
GetMovieRecommendations Gets movie recommendations.
 ...
 @return ApiGetMovieRecommendationsRequest
*/
func (a *MovieAPIService) GetMovieRecommendations(ctx context.Context) ApiGetMovieRecommendationsRequest {
	return ApiGetMovieRecommendationsRequest{
		ApiService: a,
		ctx: ctx,
	}
...
//  @return []RecommendationDto
func (a *MovieAPIService) GetMovieRecommendationsExecute(r ApiGetMovieRecommendationsRequest) ([]RecommendationDto, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "MovieAPIService.GetMovieRecommendations")
	if err != nil {

...
// SyncPlayGroupUpdateMessageAsOutboundWebSocketMessage is a convenience function that returns SyncPlayGroupUpdateMessage wrapped in OutboundWebSocketMessage
func SyncPlayGroupUpdateMessageAsOutboundWebSocketMessage(v *SyncPlayGroupUpdateMessage) OutboundWebSocketMessage {
	return OutboundWebSocketMessage{
		SyncPlayGroupUpdateMessage: v,
	}
}
...
func (dst *OutboundWebSocketMessage) UnmarshalJSON(data []byte) error {
	...
	// try to unmarshal data into SyncPlayGroupUpdateMessage
	err = newStrictDecoder(data).Decode(&dst.SyncPlayGroupUpdateMessage)
	if err == nil {
		jsonSyncPlayGroupUpdateMessage, _ := json.Marshal(dst.SyncPlayGroupUpdateMessage)
		if string(jsonSyncPlayGroupUpdateMessage) == "{}" { // empty struct
			dst.SyncPlayGroupUpdateMessage = nil
		} else {
			if err = validator.Validate(dst.SyncPlayGroupUpdateMessage); err != nil {
				dst.SyncPlayGroupUpdateMessage = nil
			} else {
				match++
			}
...
func (src OutboundWebSocketMessage) MarshalJSON() ([]byte, error) {
	...
	if src.SyncPlayGroupUpdateMessage != nil {
		return json.Marshal(&src.SyncPlayGroupUpdateMessage)
	}
...
func (obj *OutboundWebSocketMessage) GetActualInstance() (interface{}) {
	...
	if obj.SyncPlayGroupUpdateMessage != nil {
		return obj.SyncPlayGroupUpdateMessage
	}

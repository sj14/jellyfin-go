...
type UserUpdatedMessage struct {
	Data NullableAuthenticationResultUser `json:"Data,omitempty"`
...
// SetData gets a reference to the given NullableAuthenticationResultUser and assigns it to the Data field.

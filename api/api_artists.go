...
func (r ApiGetAlbumArtistsRequest) MediaTypes(mediaTypes []string) ApiGetAlbumArtistsRequest {
...
func (r ApiGetAlbumArtistsRequest) SortBy(sortBy []string) ApiGetAlbumArtistsRequest {
	r.sortBy = &sortBy
	return r
}

...
// UserViewAPIService UserViewAPI service
type UserViewAPIService service

type ApiGetGroupingOptionsRequest struct {
	ctx context.Context
	ApiService UserViewAPI
	userId *string
}
...
GetGroupingOptions Get user view grouping options.
 ...
 @return ApiGetGroupingOptionsRequest
*/
func (a *UserViewAPIService) GetGroupingOptions(ctx context.Context) ApiGetGroupingOptionsRequest {
	return ApiGetGroupingOptionsRequest{
		ApiService: a,
		ctx: ctx,
	}
...
//  @return []SpecialViewOptionDto
func (a *UserViewAPIService) GetGroupingOptionsExecute(r ApiGetGroupingOptionsRequest) ([]SpecialViewOptionDto, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "UserViewAPIService.GetGroupingOptions")
	if err != nil {
...
GetUserViews Get user views.
 ...
 @return ApiGetUserViewsRequest
*/
func (a *UserViewAPIService) GetUserViews(ctx context.Context) ApiGetUserViewsRequest {
	return ApiGetUserViewsRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return BaseItemDtoQueryResult
func (a *UserViewAPIService) GetUserViewsExecute(r ApiGetUserViewsRequest) (*BaseItemDtoQueryResult, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "UserViewAPIService.GetUserViews")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

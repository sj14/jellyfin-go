...
DeleteAlternateSources Removes alternate video sources.
 ...
 @return ApiDeleteAlternateSourcesRequest
*/
func (a *VideoAPIService) DeleteAlternateSources(ctx context.Context, itemId string) ApiDeleteAlternateSourcesRequest {
	return ApiDeleteAlternateSourcesRequest{
		ApiService: a,
		ctx: ctx,
		itemId: itemId,
...
func (a *VideoAPIService) DeleteAlternateSourcesExecute(r ApiDeleteAlternateSourcesRequest) (*http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "VideoAPIService.DeleteAlternateSources")
	if err != nil {
...
GetAdditionalPart Gets additional parts for a video.
 ...
 @return ApiGetAdditionalPartRequest
*/
func (a *VideoAPIService) GetAdditionalPart(ctx context.Context, itemId string) ApiGetAdditionalPartRequest {
	return ApiGetAdditionalPartRequest{
		ApiService: a,
		ctx: ctx,
		itemId: itemId,
...
// Execute executes the request
//  @return BaseItemDtoQueryResult
func (a *VideoAPIService) GetAdditionalPartExecute(r ApiGetAdditionalPartRequest) (*BaseItemDtoQueryResult, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "VideoAPIService.GetAdditionalPart")
	if err != nil {
...
GetAttachment Get video attachment.
 ...
 @return ApiGetAttachmentRequest
*/
func (a *VideoAPIService) GetAttachment(ctx context.Context, videoId string, mediaSourceId string, index int32) ApiGetAttachmentRequest {
	return ApiGetAttachmentRequest{
		ApiService: a,
		ctx: ctx,
		videoId: videoId,
...
// Execute executes the request
//  @return *os.File
func (a *VideoAPIService) GetAttachmentExecute(r ApiGetAttachmentRequest) (*os.File, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "VideoAPIService.GetAttachment")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
GetVideoStream Gets a video stream.
 ...
 @return ApiGetVideoStreamRequest
*/
func (a *VideoAPIService) GetVideoStream(ctx context.Context, itemId string) ApiGetVideoStreamRequest {
	return ApiGetVideoStreamRequest{
		ApiService: a,
		ctx: ctx,
		itemId: itemId,
...
// Execute executes the request
//  @return *os.File
func (a *VideoAPIService) GetVideoStreamExecute(r ApiGetVideoStreamRequest) (*os.File, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "VideoAPIService.GetVideoStream")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
	...
	if r.streamOptions != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "streamOptions", r.streamOptions, "deepObject", "")
	}
	...
	// to determine the Accept header
	localVarHTTPHeaderAccepts := []string{"video/*", "text/html"}
...
GetVideoStreamByContainer Gets a video stream.
 ...
 @return ApiGetVideoStreamByContainerRequest
*/
func (a *VideoAPIService) GetVideoStreamByContainer(ctx context.Context, itemId string, container string) ApiGetVideoStreamByContainerRequest {
	return ApiGetVideoStreamByContainerRequest{
		ApiService: a,
		ctx: ctx,
		itemId: itemId,
...
// Execute executes the request
//  @return *os.File
func (a *VideoAPIService) GetVideoStreamByContainerExecute(r ApiGetVideoStreamByContainerRequest) (*os.File, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "VideoAPIService.GetVideoStreamByContainer")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
HeadVideoStream Gets a video stream.
 ...
 @return ApiHeadVideoStreamRequest
*/
func (a *VideoAPIService) HeadVideoStream(ctx context.Context, itemId string) ApiHeadVideoStreamRequest {
	return ApiHeadVideoStreamRequest{
		ApiService: a,
		ctx: ctx,
		itemId: itemId,
...
// Execute executes the request
//  @return *os.File
func (a *VideoAPIService) HeadVideoStreamExecute(r ApiHeadVideoStreamRequest) (*os.File, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "VideoAPIService.HeadVideoStream")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
HeadVideoStreamByContainer Gets a video stream.
 ...
 @return ApiHeadVideoStreamByContainerRequest
*/
func (a *VideoAPIService) HeadVideoStreamByContainer(ctx context.Context, itemId string, container string) ApiHeadVideoStreamByContainerRequest {
	return ApiHeadVideoStreamByContainerRequest{
		ApiService: a,
		ctx: ctx,
		itemId: itemId,
...
// Execute executes the request
//  @return *os.File
func (a *VideoAPIService) HeadVideoStreamByContainerExecute(r ApiHeadVideoStreamByContainerRequest) (*os.File, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodHead
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "VideoAPIService.HeadVideoStreamByContainer")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
MergeVersions Merges videos into a single record.
 ...
 @return ApiMergeVersionsRequest
*/
func (a *VideoAPIService) MergeVersions(ctx context.Context) ApiMergeVersionsRequest {
	return ApiMergeVersionsRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
func (a *VideoAPIService) MergeVersionsExecute(r ApiMergeVersionsRequest) (*http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "VideoAPIService.MergeVersions")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

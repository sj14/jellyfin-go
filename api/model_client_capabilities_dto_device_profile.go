...
// checks if the ClientCapabilitiesDtoDeviceProfile type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ClientCapabilitiesDtoDeviceProfile{}

// ClientCapabilitiesDtoDeviceProfile Gets or sets the device profile.
type ClientCapabilitiesDtoDeviceProfile struct {
...
func NewClientCapabilitiesDtoDeviceProfile() *ClientCapabilitiesDtoDeviceProfile {
	this := ClientCapabilitiesDtoDeviceProfile{}
	return &this
}
...
func (o *ClientCapabilitiesDtoDeviceProfile) SetNameNil() {
	o.Name.Set(nil)
}
...
func (o *ClientCapabilitiesDtoDeviceProfile) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *ClientCapabilitiesDtoDeviceProfile) SetMaxStreamingBitrateNil() {
...
func (o *ClientCapabilitiesDtoDeviceProfile) SetMaxStaticBitrateNil() {
...
func (o *ClientCapabilitiesDtoDeviceProfile) SetMusicStreamingTranscodingBitrateNil() {
...
func (o *ClientCapabilitiesDtoDeviceProfile) SetMaxStaticMusicBitrateNil() {
...
func (o ClientCapabilitiesDtoDeviceProfile) MarshalJSON() ([]byte, error) {
...
func (o ClientCapabilitiesDtoDeviceProfile) ToMap() (map[string]interface{}, error) {
...
type NullableClientCapabilitiesDtoDeviceProfile struct {
	value *ClientCapabilitiesDtoDeviceProfile
	isSet bool
}

func (v NullableClientCapabilitiesDtoDeviceProfile) Get() *ClientCapabilitiesDtoDeviceProfile {
	return v.value
}

func (v *NullableClientCapabilitiesDtoDeviceProfile) Set(val *ClientCapabilitiesDtoDeviceProfile) {
	v.value = val
	v.isSet = true
}

func (v NullableClientCapabilitiesDtoDeviceProfile) IsSet() bool {
	return v.isSet
}

func (v *NullableClientCapabilitiesDtoDeviceProfile) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableClientCapabilitiesDtoDeviceProfile(val *ClientCapabilitiesDtoDeviceProfile) *NullableClientCapabilitiesDtoDeviceProfile {
	return &NullableClientCapabilitiesDtoDeviceProfile{value: val, isSet: true}
}

func (v NullableClientCapabilitiesDtoDeviceProfile) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableClientCapabilitiesDtoDeviceProfile) UnmarshalJSON(src []byte) error {
	v.isSet = true

...
// GetMediaSegmentProviderOrder returns the MediaSegmentProviderOrder field value if set, zero value otherwise.
func (o *LibraryOptions) GetMediaSegmentProviderOrder() []string {
	if o == nil || IsNil(o.MediaSegmentProviderOrder) {
		var ret []string
		return ret
	}
	return o.MediaSegmentProviderOrder
}

// GetMediaSegmentProviderOrderOk returns a tuple with the MediaSegmentProviderOrder field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *LibraryOptions) GetMediaSegmentProviderOrderOk() ([]string, bool) {
	if o == nil || IsNil(o.MediaSegmentProviderOrder) {
		return nil, false
	}
	return o.MediaSegmentProviderOrder, true
}
...
// SetMediaSegmentProviderOrder gets a reference to the given []string and assigns it to the MediaSegmentProviderOrder field.
func (o *LibraryOptions) SetMediaSegmentProviderOrder(v []string) {
	o.MediaSegmentProviderOrder = v
}
...
func (o LibraryOptions) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.MediaSegmentProviderOrder) {
		toSerialize["MediaSegmentProviderOrder"] = o.MediaSegmentProviderOrder
	}

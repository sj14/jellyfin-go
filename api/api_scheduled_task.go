...
type ScheduledTaskAPIService service
...
GetTask Get task by id.
 ...
 @return ApiGetTaskRequest
*/
func (a *ScheduledTaskAPIService) GetTask(ctx context.Context, taskId string) ApiGetTaskRequest {
	return ApiGetTaskRequest{
		ApiService: a,
		ctx: ctx,
		taskId: taskId,
...
//  @return TaskInfo
func (a *ScheduledTaskAPIService) GetTaskExecute(r ApiGetTaskRequest) (*TaskInfo, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ScheduledTaskAPIService.GetTask")
	if err != nil {
...
GetTasks Get tasks.
 ...
 @return ApiGetTasksRequest
*/
func (a *ScheduledTaskAPIService) GetTasks(ctx context.Context) ApiGetTasksRequest {
	return ApiGetTasksRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return []TaskInfo
func (a *ScheduledTaskAPIService) GetTasksExecute(r ApiGetTasksRequest) ([]TaskInfo, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ScheduledTaskAPIService.GetTasks")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
StartTask Start specified task.
 ...
 @return ApiStartTaskRequest
*/
func (a *ScheduledTaskAPIService) StartTask(ctx context.Context, taskId string) ApiStartTaskRequest {
	return ApiStartTaskRequest{
		ApiService: a,
		ctx: ctx,
		taskId: taskId,
...
// Execute executes the request
func (a *ScheduledTaskAPIService) StartTaskExecute(r ApiStartTaskRequest) (*http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ScheduledTaskAPIService.StartTask")
	if err != nil {
...
StopTask Stop specified task.
 ...
 @return ApiStopTaskRequest
*/
func (a *ScheduledTaskAPIService) StopTask(ctx context.Context, taskId string) ApiStopTaskRequest {
	return ApiStopTaskRequest{
		ApiService: a,
		ctx: ctx,
		taskId: taskId,
...
// Execute executes the request
func (a *ScheduledTaskAPIService) StopTaskExecute(r ApiStopTaskRequest) (*http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ScheduledTaskAPIService.StopTask")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}
...
UpdateTask Update specified task triggers.
 ...
 @return ApiUpdateTaskRequest
*/
func (a *ScheduledTaskAPIService) UpdateTask(ctx context.Context, taskId string) ApiUpdateTaskRequest {
	return ApiUpdateTaskRequest{
		ApiService: a,
		ctx: ctx,
		taskId: taskId,
...
// Execute executes the request
func (a *ScheduledTaskAPIService) UpdateTaskExecute(r ApiUpdateTaskRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ScheduledTaskAPIService.UpdateTask")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

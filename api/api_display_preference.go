...
type DisplayPreferenceAPI interface {
...
// DisplayPreferenceAPIService DisplayPreferenceAPI service
type DisplayPreferenceAPIService service

type ApiGetDisplayPreferencesRequest struct {
	ctx context.Context
	ApiService DisplayPreferenceAPI
...
GetDisplayPreferences Get Display Preferences.
 ...
 @return ApiGetDisplayPreferencesRequest
*/
func (a *DisplayPreferenceAPIService) GetDisplayPreferences(ctx context.Context, displayPreferencesId string) ApiGetDisplayPreferencesRequest {
	return ApiGetDisplayPreferencesRequest{
		ApiService: a,
		ctx: ctx,
...
//  @return DisplayPreferencesDto
func (a *DisplayPreferenceAPIService) GetDisplayPreferencesExecute(r ApiGetDisplayPreferencesRequest) (*DisplayPreferencesDto, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DisplayPreferenceAPIService.GetDisplayPreferences")
	if err != nil {
...
UpdateDisplayPreferences Update Display Preferences.
 ...
 @return ApiUpdateDisplayPreferencesRequest
*/
func (a *DisplayPreferenceAPIService) UpdateDisplayPreferences(ctx context.Context, displayPreferencesId string) ApiUpdateDisplayPreferencesRequest {
	return ApiUpdateDisplayPreferencesRequest{
		ApiService: a,
		ctx: ctx,
		displayPreferencesId: displayPreferencesId,
...
// Execute executes the request
func (a *DisplayPreferenceAPIService) UpdateDisplayPreferencesExecute(r ApiUpdateDisplayPreferencesRequest) (*http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DisplayPreferenceAPIService.UpdateDisplayPreferences")
	if err != nil {

...
type SuggestionsAPI interface {
	...
	*/
	GetSuggestions(ctx context.Context, userId string) ApiGetSuggestionsRequest
...
// The media types.
func (r ApiGetSuggestionsRequest) MediaType(mediaType []string) ApiGetSuggestionsRequest {
...
GetSuggestions Gets suggestions.
 ...
 @return ApiGetSuggestionsRequest
*/
func (a *SuggestionsAPIService) GetSuggestions(ctx context.Context, userId string) ApiGetSuggestionsRequest {
	return ApiGetSuggestionsRequest{
		ApiService: a,
		ctx: ctx,
		userId: userId,

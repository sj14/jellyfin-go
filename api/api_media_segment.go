...
type MediaSegmentAPI interface {
...
// MediaSegmentAPIService MediaSegmentAPI service
type MediaSegmentAPIService service

type ApiGetItemSegmentsRequest struct {
	ctx context.Context
	ApiService MediaSegmentAPI
	itemId string
...
GetItemSegments Gets all media segments based on an itemId.
 ...
 @return ApiGetItemSegmentsRequest
*/
func (a *MediaSegmentAPIService) GetItemSegments(ctx context.Context, itemId string) ApiGetItemSegmentsRequest {
	return ApiGetItemSegmentsRequest{
		ApiService: a,
		ctx: ctx,
		itemId: itemId,
...
//  @return MediaSegmentDtoQueryResult
func (a *MediaSegmentAPIService) GetItemSegmentsExecute(r ApiGetItemSegmentsRequest) (*MediaSegmentDtoQueryResult, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "MediaSegmentAPIService.GetItemSegments")
	if err != nil {

...
func (r ApiGetUniversalAudioStreamRequest) TranscodingProtocol(transcodingProtocol string) ApiGetUniversalAudioStreamRequest {
...
// Optional. The transcoding protocol.
func (r ApiHeadUniversalAudioStreamRequest) TranscodingProtocol(transcodingProtocol string) ApiHeadUniversalAudioStreamRequest {
	r.transcodingProtocol = &transcodingProtocol
	return r
}

...
type MediaSourceInfo struct {
	...
	TranscodingSubProtocol NullableString `json:"TranscodingSubProtocol,omitempty"`
...
// GetTranscodingSubProtocol returns the TranscodingSubProtocol field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *MediaSourceInfo) GetTranscodingSubProtocol() string {
	if o == nil || IsNil(o.TranscodingSubProtocol.Get()) {
		var ret string
		return ret
	}
	return *o.TranscodingSubProtocol.Get()
}
...
// SetTranscodingSubProtocol gets a reference to the given NullableString and assigns it to the TranscodingSubProtocol field.
func (o *MediaSourceInfo) SetTranscodingSubProtocol(v string) {
	o.TranscodingSubProtocol.Set(&v)
}
// SetTranscodingSubProtocolNil sets the value for TranscodingSubProtocol to be an explicit nil
func (o *MediaSourceInfo) SetTranscodingSubProtocolNil() {
	o.TranscodingSubProtocol.Set(nil)
}
...
func (o *MediaSourceInfo) UnsetTranscodingSubProtocol() {
	o.TranscodingSubProtocol.Unset()
}
...
func (o MediaSourceInfo) ToMap() (map[string]interface{}, error) {
	...
	if o.TranscodingSubProtocol.IsSet() {
		toSerialize["TranscodingSubProtocol"] = o.TranscodingSubProtocol.Get()
	}

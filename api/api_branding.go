...
type BrandingAPI interface {
	...
	*/
	...
	GetBrandingOptionsExecute(r ApiGetBrandingOptionsRequest) (*BrandingOptionsDto, *http.Response, error)
}
...
func (a *BrandingAPIService) GetBrandingCssExecute(r ApiGetBrandingCssRequest) (string, *http.Response, error) {
	...
	localVarHTTPHeaderAccepts := []string{"text/css", "application/json", "application/json; profile=CamelCase", "application/json; profile=PascalCase", "text/html"}
...
func (r ApiGetBrandingOptionsRequest) Execute() (*BrandingOptionsDto, *http.Response, error) {
...
// Execute executes the request
//  @return BrandingOptionsDto
func (a *BrandingAPIService) GetBrandingOptionsExecute(r ApiGetBrandingOptionsRequest) (*BrandingOptionsDto, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *BrandingOptionsDto
	)

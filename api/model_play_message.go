...
type PlayMessage struct {
	Data NullablePlayMessageData `json:"Data,omitempty"`
...
// SetData gets a reference to the given NullablePlayMessageData and assigns it to the Data field.

...
// checks if the PluginUninstalledMessageData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PluginUninstalledMessageData{}

// PluginUninstalledMessageData This is a serializable stub class that is used by the api to provide information about installed plugins.
type PluginUninstalledMessageData struct {
...
func NewPluginUninstalledMessageData() *PluginUninstalledMessageData {
	this := PluginUninstalledMessageData{}
	return &this
}
...
func (o *PluginUninstalledMessageData) SetConfigurationFileNameNil() {
...
func (o PluginUninstalledMessageData) MarshalJSON() ([]byte, error) {
...
func (o PluginUninstalledMessageData) ToMap() (map[string]interface{}, error) {
...
type NullablePluginUninstalledMessageData struct {
	value *PluginUninstalledMessageData
	isSet bool
}

func (v NullablePluginUninstalledMessageData) Get() *PluginUninstalledMessageData {
	return v.value
}

func (v *NullablePluginUninstalledMessageData) Set(val *PluginUninstalledMessageData) {
	v.value = val
	v.isSet = true
}

func (v NullablePluginUninstalledMessageData) IsSet() bool {
	return v.isSet
}

func (v *NullablePluginUninstalledMessageData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePluginUninstalledMessageData(val *PluginUninstalledMessageData) *NullablePluginUninstalledMessageData {
	return &NullablePluginUninstalledMessageData{value: val, isSet: true}
}

func (v NullablePluginUninstalledMessageData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePluginUninstalledMessageData) UnmarshalJSON(src []byte) error {
	v.isSet = true

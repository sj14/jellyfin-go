...
GetGenre Gets a genre, by name.
 ...
 @return ApiGetGenreRequest
*/
func (a *GenreAPIService) GetGenre(ctx context.Context, genreName string) ApiGetGenreRequest {
	return ApiGetGenreRequest{
		ApiService: a,
		ctx: ctx,
		genreName: genreName,
...
//  @return BaseItemDto
func (a *GenreAPIService) GetGenreExecute(r ApiGetGenreRequest) (*BaseItemDto, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "GenreAPIService.GetGenre")
	if err != nil {
...
GetGenres Gets all genres from a given item, folder, or the entire library.
 ...
 @return ApiGetGenresRequest
*/
func (a *GenreAPIService) GetGenres(ctx context.Context) ApiGetGenresRequest {
	return ApiGetGenresRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return BaseItemDtoQueryResult
func (a *GenreAPIService) GetGenresExecute(r ApiGetGenresRequest) (*BaseItemDtoQueryResult, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "GenreAPIService.GetGenres")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

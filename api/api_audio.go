...
func (a *AudioAPIService) GetAudioStreamExecute(r ApiGetAudioStreamRequest) (*os.File, *http.Response, error) {
	...
	localVarHTTPHeaderAccepts := []string{"audio/*", "text/html"}
...
GetUniversalAudioStream Gets an audio stream.
 ...
 @return ApiGetUniversalAudioStreamRequest
*/
func (a *AudioAPIService) GetUniversalAudioStream(ctx context.Context, itemId string) ApiGetUniversalAudioStreamRequest {
	return ApiGetUniversalAudioStreamRequest{
		ApiService: a,
		ctx: ctx,
		itemId: itemId,
...
// Execute executes the request
//  @return *os.File
func (a *AudioAPIService) GetUniversalAudioStreamExecute(r ApiGetUniversalAudioStreamRequest) (*os.File, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AudioAPIService.GetUniversalAudioStream")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
HeadUniversalAudioStream Gets an audio stream.
 ...
 @return ApiHeadUniversalAudioStreamRequest
*/
func (a *AudioAPIService) HeadUniversalAudioStream(ctx context.Context, itemId string) ApiHeadUniversalAudioStreamRequest {
	return ApiHeadUniversalAudioStreamRequest{
		ApiService: a,
		ctx: ctx,
		itemId: itemId,
...
// Execute executes the request
//  @return *os.File
func (a *AudioAPIService) HeadUniversalAudioStreamExecute(r ApiHeadUniversalAudioStreamRequest) (*os.File, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodHead
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AudioAPIService.HeadUniversalAudioStream")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

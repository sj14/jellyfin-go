...
type PlaystateAPI interface {
	...
	*/
	MarkPlayedItem(ctx context.Context, userId string, itemId string) ApiMarkPlayedItemRequest
	...
	*/
	MarkUnplayedItem(ctx context.Context, userId string, itemId string) ApiMarkUnplayedItemRequest
	...
	*/
	OnPlaybackProgress(ctx context.Context, userId string, itemId string) ApiOnPlaybackProgressRequest
	...
	*/
	OnPlaybackStart(ctx context.Context, userId string, itemId string) ApiOnPlaybackStartRequest
	...
	*/
	OnPlaybackStopped(ctx context.Context, userId string, itemId string) ApiOnPlaybackStoppedRequest
...
MarkPlayedItem Marks an item as played for user.
 ...
 @return ApiMarkPlayedItemRequest
*/
func (a *PlaystateAPIService) MarkPlayedItem(ctx context.Context, userId string, itemId string) ApiMarkPlayedItemRequest {
	return ApiMarkPlayedItemRequest{
		ApiService: a,
		ctx: ctx,
		userId: userId,
...
func (a *PlaystateAPIService) MarkPlayedItemExecute(r ApiMarkPlayedItemRequest) (*UserItemDataDto, *http.Response, error) {
	...
	localVarPath := localBasePath + "/Users/{userId}/PlayedItems/{itemId}"
...
MarkUnplayedItem Marks an item as unplayed for user.
 ...
 @return ApiMarkUnplayedItemRequest
*/
func (a *PlaystateAPIService) MarkUnplayedItem(ctx context.Context, userId string, itemId string) ApiMarkUnplayedItemRequest {
	return ApiMarkUnplayedItemRequest{
		ApiService: a,
		ctx: ctx,
		userId: userId,
...
OnPlaybackProgress Reports a user's playback progress.
 ...
 @return ApiOnPlaybackProgressRequest
*/
func (a *PlaystateAPIService) OnPlaybackProgress(ctx context.Context, userId string, itemId string) ApiOnPlaybackProgressRequest {
	return ApiOnPlaybackProgressRequest{
		ApiService: a,
		ctx: ctx,
		userId: userId,
...
func (a *PlaystateAPIService) OnPlaybackProgressExecute(r ApiOnPlaybackProgressRequest) (*http.Response, error) {
	...
	localVarPath := localBasePath + "/Users/{userId}/PlayingItems/{itemId}/Progress"
	localVarPath = strings.Replace(localVarPath, "{"+"userId"+"}", url.PathEscape(parameterValueToString(r.userId, "userId")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"itemId"+"}", url.PathEscape(parameterValueToString(r.itemId, "itemId")), -1)
...
OnPlaybackStart Reports that a user has begun playing an item.
 ...
 @return ApiOnPlaybackStartRequest
*/
func (a *PlaystateAPIService) OnPlaybackStart(ctx context.Context, userId string, itemId string) ApiOnPlaybackStartRequest {
	return ApiOnPlaybackStartRequest{
		ApiService: a,
		ctx: ctx,
		userId: userId,
...
func (a *PlaystateAPIService) OnPlaybackStartExecute(r ApiOnPlaybackStartRequest) (*http.Response, error) {
	...
	localVarPath := localBasePath + "/Users/{userId}/PlayingItems/{itemId}"
	localVarPath = strings.Replace(localVarPath, "{"+"userId"+"}", url.PathEscape(parameterValueToString(r.userId, "userId")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"itemId"+"}", url.PathEscape(parameterValueToString(r.itemId, "itemId")), -1)
...
OnPlaybackStopped Reports that a user has stopped playing an item.
 ...
 @return ApiOnPlaybackStoppedRequest
*/
func (a *PlaystateAPIService) OnPlaybackStopped(ctx context.Context, userId string, itemId string) ApiOnPlaybackStoppedRequest {
	return ApiOnPlaybackStoppedRequest{
		ApiService: a,
		ctx: ctx,
		userId: userId,
